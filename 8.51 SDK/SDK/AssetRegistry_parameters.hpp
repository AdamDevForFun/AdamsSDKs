...
public:
	...
	uint8                                        Pad_683[0x2];                                      // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_687[0x6];                                      // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	bool                                         ReturnValue;                                       // 0x19(0x1)(Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                        Pad_688[0x6];                                      // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_68D[0x6];                                      // Fixing Size Of Struct [ Dumper-7 ]
};
