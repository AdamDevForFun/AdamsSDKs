...
{
public:
	uint8                                        Pad_15DF[0x20];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_15E0[0x17];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_15E8[0x8];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_1600[0x18];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_1602[0x55];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_1607[0x18];                                    // Fixing Size After Last Property  [ Dumper-7 ]
