...
{
public:
	uint8                                        Pad_11C7[0xB8];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_11C8[0x30];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_11CC[0x60];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
