...
{
public:
	uint8                                        Pad_642[0x140];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_648[0x10];                                     // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_649[0x10];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_64A[0x30];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
