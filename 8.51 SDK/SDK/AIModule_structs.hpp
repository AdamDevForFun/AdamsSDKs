...
public:
	...
	uint8                                        Pad_9A7[0xC];                                      // Fixing Size After Last Property  [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_9B7[0x10];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_9BB[0x3];                                      // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_9BF[0x8];                                      // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_9C2[0x28];                                     // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_9CC[0x1];                                      // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_9D4[0x170];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_9D6[0x50];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_9DC[0x10];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_9DD[0x14];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_9DF[0xC];                                      // Fixing Size Of Struct [ Dumper-7 ]
};
