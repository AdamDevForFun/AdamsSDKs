...
public:
	...
	TMap<class UClass*, class UFortPlayerSurveyAnswerWidgetBase*> SwitcherWidgets;                                   // 0x258(0x50)(Edit, BlueprintVisible, ZeroConstructor, Transient, DisableEditOnInstance)
