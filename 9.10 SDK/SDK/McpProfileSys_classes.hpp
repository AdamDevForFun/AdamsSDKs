...
public:
	...
	uint8                                        Pad_1698[0x57];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_1699[0x1D];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_169B[0x3C];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_169C[0xF0];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_169F[0x40];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_16A3[0x1E];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_16A4[0x10];                                    // Fixing Size After Last Property  [ Dumper-7 ]
