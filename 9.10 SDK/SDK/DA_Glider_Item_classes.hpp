...
public:
	...
	struct FGameplayTagContainer                 ErrorReason;                                       // 0x9B8(0x20)(Edit, BlueprintVisible, DisableEditOnInstance)
	struct FGameplayTagContainer                 ErrorReasonGamepad;                                // 0x9D8(0x20)(Edit, BlueprintVisible, DisableEditOnInstance)
	struct FGameplayTagContainer                 ErrorCannotUse;                                    // 0x9F8(0x20)(Edit, BlueprintVisible, DisableEditOnInstance)
