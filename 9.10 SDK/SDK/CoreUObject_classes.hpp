...
public:
	...
	uint8                                        Pad_4[0x44];                                       // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_19[0x4];                                       // Fixing Size After Last (Predefined) Property  [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_1D[0x1B8];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_1E[0xC8];                                      // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_1F[0x1B8];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_20[0xA0];                                      // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_27[0x18];                                      // Fixing Size Of Struct [ Dumper-7 ]
