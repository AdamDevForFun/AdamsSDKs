...
public:
	...
	uint8                                        Pad_459[0xC];                                      // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_45A[0xC];                                      // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	int32                                        InstanceIndex;                                     // 0x0(0x4)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                        Pad_45D[0xC];                                      // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_45E[0xE];                                      // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_4AF[0x5];                                      // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_4B3[0x5];                                      // Fixing Size Of Struct [ Dumper-7 ]
};
