...
public:
	...
	uint8                                        Pad_13[0x5];                                       // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_14[0x6];                                       // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_29[0x2];                                       // Fixing Size After Last Property  [ Dumper-7 ]
	class UCommonInputSubsystem*                 CallFunc_GetContext_ReturnValue;                   // 0x8(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	enum class ECommonInputType                  CallFunc_GetCurrentInputType_ReturnValue;          // 0x10(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                         CallFunc_EqualEqual_ByteByte_ReturnValue;          // 0x11(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
	bool                                         CallFunc_HasAnyChildren_ReturnValue;               // 0x12(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                        Pad_2B[0x5];                                       // Fixing Size After Last Property  [ Dumper-7 ]
