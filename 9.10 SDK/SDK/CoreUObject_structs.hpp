...
{
public:
	uint8                                        Pad_30[0x1];                                       // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	float                                        InVal;                                             // 0x0(0x4)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                        Pad_39[0xC];                                       // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_3A[0xF];                                       // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_46[0x1];                                       // Fixing Size Of Struct [ Dumper-7 ]
};
