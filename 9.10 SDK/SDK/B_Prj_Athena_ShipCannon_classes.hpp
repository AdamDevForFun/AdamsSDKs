...
public:
	...
	class UParticleSystemComponent*              P_Cannon_Projectile_Spin;                          // 0x6D8(0x8)(BlueprintVisible, ZeroConstructor, InstancedReference, IsPlainOldData, NonTransactional, NoDestructor, HasGetValueTypeHash)
	class USoundBase*                            Cannonball_SurfaceImpactSound;                     // 0x6E0(0x8)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class USoundBase*                            Cannonball_PlayerImpactSound;                      // 0x6E8(0x8)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class USoundBase*                            Cannonball_ExplosionSound;                         // 0x6F0(0x8)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FVector                               StartingVelocity;                                  // 0x6F8(0xC)(Edit, BlueprintVisible, Net, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                        Pad_57C6[0x4];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	class ABuildingActor*                        LastHitBuilding;                                   // 0x708(0x8)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnTemplate, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FScalableFloat                        EnemyLaunchVelocity;                               // 0x710(0x20)(Edit, BlueprintVisible, DisableEditOnInstance)
	struct FScalableFloat                        VelocityLossMultiplier;                            // 0x730(0x20)(Edit, BlueprintVisible, DisableEditOnInstance)
	struct FScalableFloat                        MinimumVelocity;                                   // 0x750(0x20)(Edit, BlueprintVisible, DisableEditOnInstance)
	struct FScalableFloat                        CannonballInitialSpeed;                            // 0x770(0x20)(Edit, BlueprintVisible, DisableEditOnInstance)
	struct FScalableFloat                        CannonballGravityScale;                            // 0x790(0x20)(Edit, BlueprintVisible, DisableEditOnInstance)
