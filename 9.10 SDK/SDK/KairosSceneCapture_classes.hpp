...
public:
	...
	uint8                                        Pad_1F7[0x6];                                      // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_1FE[0x1F];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	struct FKairosSceneInfo                      ActiveSceneInfo;                                   // 0x2F0(0x20)(Protected, NativeAccessSpecifierProtected)
	uint8                                        Pad_1FF[0xB0];                                     // Fixing Size Of Struct [ Dumper-7 ]
