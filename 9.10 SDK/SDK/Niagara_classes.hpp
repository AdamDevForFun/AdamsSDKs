...
public:
	...
	uint8                                        Pad_14DC[0x4];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_14E4[0x27];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_14E6[0x1];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_14E7[0x33];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_14E9[0x1B];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_14EE[0x5];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_14F1[0x5];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_1513[0x148];                                   // Fixing Size After Last Property  [ Dumper-7 ]
	struct FNiagaraVMExecutableData              CachedScriptVM;                                    // 0x560(0x178)(NativeAccessSpecifierPrivate)
	TArray<class UNiagaraParameterCollection*>   CachedParameterCollectionReferences;               // 0x6D8(0x10)(ZeroConstructor, NativeAccessSpecifierPrivate)
	TArray<struct FNiagaraScriptDataInterfaceInfo> CachedDefaultDataInterfaces;                       // 0x6E8(0x10)(ZeroConstructor, NativeAccessSpecifierPrivate)
...
{
public:
	uint8                                        Pad_1514[0x20];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        BitPad_173 : 5;                                    // Fixing Bit-Field Size  [ Dumper-7 ]
	...
	uint8                                        Pad_1518[0x14];                                    // Fixing Size Of Struct [ Dumper-7 ]
