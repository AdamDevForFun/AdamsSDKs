...
// class ABP_SolarisPrototype_C*      CallFunc_FinishSpawningActor_ReturnValue                         (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void AMinigameSettingsMachine_C::LoadOrCreateVPL(const struct FTransform& CallFunc_MakeTransform_ReturnValue, class AActor* CallFunc_BeginDeferredActorSpawnFromClass_ReturnValue, class ABP_SolarisPrototype_C* CallFunc_FinishSpawningActor_ReturnValue)
{
	static class UFunction* Func = nullptr;
...
// class ASolarisPrototype*           Temp_object_Variable                                             (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// class AFortMinigame*               CallFunc_GetCurrentMinigame_Minigame                             (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// class ASolarisPrototype*           K2Node_Select_Default                                            (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void AMinigameSettingsMachine_C::ToggleScriptedGameRules(bool bIsScriptedGame, bool Temp_bool_Variable, class ASolarisPrototype* Temp_object_Variable, class AFortMinigame* CallFunc_GetCurrentMinigame_Minigame, class ASolarisPrototype* K2Node_Select_Default)
{
	static class UFunction* Func = nullptr;
