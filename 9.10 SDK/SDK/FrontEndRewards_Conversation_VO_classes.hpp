...
public:
	...
	void HandleConversationFinished(bool CallFunc_IsValid_ReturnValue, class UFortQuestItemDefinition* CallFunc_GetQuestDefinitionBP_ReturnValue, bool CallFunc_IsValid_ReturnValue_1, enum class EFortQuestRewardType CallFunc_GetRewardType_ReturnValue, bool CallFunc_EqualEqual_ByteByte_ReturnValue);
	...
	void HandleReplayAction(bool* Committed, bool CallFunc_IsValid_ReturnValue, bool CallFunc_IsValid_ReturnValue_1);
