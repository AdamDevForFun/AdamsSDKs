...
{
public:
	uint8                                        Pad_3A54[0x1];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_3A56[0x1];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_3A57[0x7];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_3A5A[0x7];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
