...
public:
	...
	UMulticastInlineDelegateProperty_            EventViewLiveGames;                                // 0x480(0x10)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
