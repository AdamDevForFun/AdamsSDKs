...
public:
	...
	uint8                                        Pad_52F1[0x6];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_52F2[0x5];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	class FText                                  CallFunc_GetBRConfirmationDialogText_TitleText;    // 0x2D0(0x18)(None)
	class FText                                  CallFunc_GetBRConfirmationDialogText_MessagText;   // 0x2E8(0x18)(None)
	...
	class FText                                  CallFunc_GetSTWOutpostConfirmationDialogText_OutTitle; // 0x310(0x18)(None)
	class FText                                  CallFunc_GetSTWOutpostConfirmationDialogText_OutDescription; // 0x328(0x18)(None)
