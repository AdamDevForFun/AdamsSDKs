...
public:
	...
	class UFortWorldItemDefinition*              SnowmanItemDef;                                    // 0x930(0x8)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	struct FScalableFloat                        ShouldSnowmanInTurret;                             // 0x940(0x20)(Edit, BlueprintVisible, DisableEditOnInstance)
	TArray<class UFortItem*>                     SnowmanItemInstances;                              // 0x960(0x10)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance)
