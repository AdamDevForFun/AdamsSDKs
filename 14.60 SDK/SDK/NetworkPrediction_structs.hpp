...
{
public:
	uint8                                        Pad_316F[0x90];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_3171[0x8];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_3172[0x18];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_3173[0x50];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
