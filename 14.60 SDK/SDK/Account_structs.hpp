...
public:
	...
	uint8                                        Pad_360C[0x10];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	class FText                                  MCPTimeout;                                        // 0x588(0x18)(Edit, NativeAccessSpecifierPublic)
	class FText                                  LightswitchCheckNetworkFailureMsg;                 // 0x5A0(0x18)(Edit, NativeAccessSpecifierPublic)
	class FText                                  NetworkConnectionUnavailable;                      // 0x5B8(0x18)(Edit, NativeAccessSpecifierPublic)
	class FText                                  NoPlayEntitlement;                                 // 0x5D0(0x18)(Edit, NativeAccessSpecifierPublic)
	class FText                                  NoServerAccess;                                    // 0x5E8(0x18)(Edit, NativeAccessSpecifierPublic)
	class FText                                  PlayAccessRevoked;                                 // 0x600(0x18)(Edit, NativeAccessSpecifierPublic)
	class FText                                  PremiumAccountName_Default;                        // 0x618(0x18)(Edit, NativeAccessSpecifierPublic)
	class FText                                  PremiumAccountName_PS4;                            // 0x630(0x18)(Edit, NativeAccessSpecifierPublic)
	...
	struct FOnlineAccountTexts_FailedLoginConsole FailedLoginConsole;                                // 0x7E0(0x138)(Edit, NativeAccessSpecifierPublic)
	class FText                                  LoggingInExternalAuth;                             // 0x918(0x18)(Edit, NativeAccessSpecifierPublic)
	class FText                                  CreateDeviceAuth;                                  // 0x930(0x18)(Edit, NativeAccessSpecifierPublic)
	class FText                                  ExtAuthCanceled;                                   // 0x948(0x18)(Edit, NativeAccessSpecifierPublic)
	class FText                                  ExtAuthFailure;                                    // 0x960(0x18)(Edit, NativeAccessSpecifierPublic)
	class FText                                  ExtAuthAssociationFailure;                         // 0x978(0x18)(Edit, NativeAccessSpecifierPublic)
	class FText                                  ExtAuthTimeout;                                    // 0x990(0x18)(Edit, NativeAccessSpecifierPublic)
	class FText                                  ExtAuthMissingAuthAssociation;                     // 0x9A8(0x18)(Edit, NativeAccessSpecifierPublic)
	class FText                                  UnableToQueryReceipts;                             // 0x9C0(0x18)(Edit, DisableEditOnInstance, NativeAccessSpecifierPublic)
};
