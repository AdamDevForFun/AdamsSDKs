...
public:
	...
	TArray<struct FVector>                       CallFunc_CalculateProjectileTrajectorySpline_OutSplinePoints; // 0x48(0x10)(ReferenceParm, HasGetValueTypeHash)
	TArray<struct FVector>                       CallFunc_CalculateProjectileTrajectorySpline_OutSplineTangents; // 0x58(0x10)(ReferenceParm, HasGetValueTypeHash)
};
...
public:
	...
	uint8                                        Pad_5933[0xF];                                     // Fixing Size After Last Property  [ Dumper-7 ]
