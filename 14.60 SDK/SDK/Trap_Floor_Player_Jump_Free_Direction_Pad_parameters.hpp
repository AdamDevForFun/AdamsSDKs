...
public:
	...
	TArray<class AActor*>                        LocalTouching;                                     // 0x18(0x10)(Edit, BlueprintVisible, DisableEditOnTemplate, HasGetValueTypeHash)
};
...
public:
	...
	uint8                                        Pad_27F4[0xF];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	TArray<struct FParticleSysParam>             K2Node_MakeArray_Array;                            // 0x420(0x10)(ReferenceParm, HasGetValueTypeHash)
	...
	uint8                                        Pad_27FA[0x6];                                     // Fixing Size After Last Property  [ Dumper-7 ]
