...
public:
	...
	struct FHitResult                            CallFunc_K2_SetWorldLocationAndRotation_SweepHitResult; // 0xE0(0x8C)(IsPlainOldData, NoDestructor, ContainsInstancedReference)
	...
	TArray<struct FHitResult>                    CallFunc_BoxTraceMulti_OutHits;                    // 0x178(0x10)(ReferenceParm, ContainsInstancedReference, HasGetValueTypeHash)
	...
	struct FHitResult                            CallFunc_Array_Get_Item;                           // 0x18C(0x8C)(IsPlainOldData, NoDestructor, ContainsInstancedReference)
	...
	uint8                                        Pad_6A4C[0x2];                                     // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	...
	TArray<struct FVector>                       K2Node_Event_SplinePoints;                         // 0x18(0x10)(ConstParm, ReferenceParm, HasGetValueTypeHash)
	TArray<struct FVector>                       K2Node_Event_SplineTangents;                       // 0x28(0x10)(ConstParm, ReferenceParm, HasGetValueTypeHash)
	...
	struct FLinearColor                          CallFunc_Conv_VectorToLinearColor_ReturnValue_1;   // 0xB4(0x10)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	struct FVector                               CallFunc_Multiply_VectorFloat_ReturnValue_1;       // 0xD4(0xC)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	class USplineMeshComponent*                  CallFunc_Array_Get_Item_4;                         // 0xF8(0x8)(ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	bool                                         CallFunc_Less_IntInt_ReturnValue_2;                // 0x11C(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
	...
	struct FVector                               CallFunc_GetLocationAtSplinePoint_ReturnValue_1;   // 0x12C(0xC)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FHitResult                            CallFunc_K2_SetWorldLocation_SweepHitResult;       // 0x138(0x8C)(IsPlainOldData, NoDestructor, ContainsInstancedReference)
};
