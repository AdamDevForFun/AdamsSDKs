...
{
public:
	uint8                                        Pad_4294[0x40];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	...
	TArray<class FString>                        ParentIds;                                         // 0x300(0x10)(Net, ZeroConstructor, RepNotify, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
{
public:
	int32                                        MaxConnections;                                    // 0x308(0x4)(ZeroConstructor, Config, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
{
public:
	uint8                                        Pad_429C[0x18];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_42A0[0x8];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_42B2[0x30];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_42B3[0x54];                                    // Fixing Size Of Struct [ Dumper-7 ]
