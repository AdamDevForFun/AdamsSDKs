...
{
public:
	uint8                                        Pad_4646[0x8];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	TArray<struct FProcMeshSection>              ProcMeshSections;                                  // 0x480(0x10)(ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	TArray<struct FKConvexElem>                  CollisionConvexElems;                              // 0x490(0x10)(ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	...
	TArray<class UBodySetup*>                    AsyncBodySetupQueue;                               // 0x4C0(0x10)(ZeroConstructor, Transient, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
