...
{
public:
	TArray<struct FManagedGameplayTagDataTableItem> Tables;                                            // 0x30(0x10)(Edit, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                        Pad_4E76[0x58];                                    // Fixing Size Of Struct [ Dumper-7 ]
