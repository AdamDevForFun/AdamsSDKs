...
public:
	...
	TArray<struct FFortItemQuantityPair>         Pairs;                                             // 0x8(0x10)(Parm, OutParm, HasGetValueTypeHash)
	TArray<struct FFortItemQuantityPair>         Results;                                           // 0x18(0x10)(Edit, BlueprintVisible, HasGetValueTypeHash)
...
public:
	...
	TArray<struct FFortItemQuantityPair>         CallFunc_GetRecipeItemQuantityPairs_Pairs;         // 0x8(0x10)(ReferenceParm, HasGetValueTypeHash)
	TArray<struct FFortItemQuantityPair>         CallFunc_GetRecipeItemQuantityPairs_Pairs_1;       // 0x18(0x10)(ReferenceParm, HasGetValueTypeHash)
};
