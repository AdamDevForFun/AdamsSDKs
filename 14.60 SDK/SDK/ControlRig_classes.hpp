...
{
public:
	uint8                                        Pad_3A62[0x4C];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_3A67[0x38];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_3A6A[0x8];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_3A6C[0x10];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_3A77[0x18];                                    // Fixing Size Of Struct [ Dumper-7 ]
