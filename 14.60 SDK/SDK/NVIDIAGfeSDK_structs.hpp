...
public:
	...
	uint8                                        Pad_53E2[0x6];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	TArray<struct FGfeSDKHighlightGroupView>     GroupViews;                                        // 0x0(0x10)(ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
...
public:
	...
	uint8                                        Pad_53E3[0x7];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	TArray<enum class EGfeSDKScope>              Scopes;                                            // 0x0(0x10)(ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
...
public:
	...
	uint8                                        Pad_53E4[0x5];                                     // Fixing Size After Last Property  [ Dumper-7 ]
...
{
public:
	TArray<struct FGfeSDKHighlightDefinition>    HighlightDefinitions;                              // 0x0(0x10)(ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
public:
	...
	TArray<enum class EGfeSDKScope>              RequiredScopes;                                    // 0x10(0x10)(ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	uint8                                        Pad_53E6[0x7];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
