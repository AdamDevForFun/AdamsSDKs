...
{
public:
	uint8                                        Pad_3C91[0x8];                                     // Fixing Size After Last Property  [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_3CAC[0x10];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        BitPad_276 : 5;                                    // Fixing Bit-Field Size  [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_3CB5[0x108];                                   // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_3CBC[0xC];                                     // Fixing Size Of Struct [ Dumper-7 ]
