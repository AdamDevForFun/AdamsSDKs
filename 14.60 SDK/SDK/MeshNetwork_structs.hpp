...
{
public:
	TSet<class FName>                            Parameters;                                        // 0x0(0x50)(Edit, NativeAccessSpecifierPublic)
};
...
public:
	...
	uint8                                        Pad_42B7[0x20];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_42B8[0x1];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
