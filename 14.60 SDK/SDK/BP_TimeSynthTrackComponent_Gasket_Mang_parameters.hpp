...
struct UBP_TimeSynthTrackComponent_Gasket_Mang_C_HandleMixState_Params
{
public:
	...
	float                                        CallFunc_MapRangeClamped_ReturnValue_3;            // 0x10(0x4)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};

// 0xC (0xC - 0x0)
// Function BP_TimeSynthTrackComponent_Gasket_Mang.BP_TimeSynthTrackComponent_Gasket_Mang_C.GetRemainingEventCooldown
struct UBP_TimeSynthTrackComponent_Gasket_Mang_C_GetRemainingEventCooldown_Params
{
public:
...
struct UBP_TimeSynthTrackComponent_Gasket_Mang_C_OnDataTrackerUpdate_Params
{
public:
	...
	float                                        CallFunc_GetAccumulationValue_ReturnValue;         // 0x10(0x4)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	float                                        CallFunc_GetAccumulationValue_ReturnValue_1;       // 0x14(0x4)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	uint8                                        Pad_7744[0x2];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	float                                        CallFunc_FInterpTo_ReturnValue_1;                  // 0x28(0x4)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	float                                        CallFunc_GetAccumulationValue_ReturnValue_2;       // 0x2C(0x4)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                         CallFunc_Greater_FloatFloat_ReturnValue_2;         // 0x30(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                        Pad_7747[0x3];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	float                                        CallFunc_SelectFloat_ReturnValue_2;                // 0x34(0x4)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	float                                        CallFunc_FInterpTo_ReturnValue_2;                  // 0x38(0x4)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
