...
{
public:
	TArray<class FText>                          NewParam;                                          // 0x0(0x10)(BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ReferenceParm, HasGetValueTypeHash)
};
...
public:
	...
	TArray<class FString>                        CallFunc_GetKBMPlayerInputPresetNamesForSubGame_InputPresetNames; // 0x40(0x10)(ReferenceParm, HasGetValueTypeHash)
	TArray<class FText>                          CallFunc_GetKBMPlayerInputPresetNamesForSubGame_InputPresetFriendlyNames; // 0x50(0x10)(ReferenceParm, HasGetValueTypeHash)
};
