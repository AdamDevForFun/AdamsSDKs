...
struct UTopBar_C_SetTopTabsVisibility_Params
{
public:
...
public:
	...
	TArray<struct FRuntimeOptionTabStateInfo>    CallFunc_GetDisabledFrontendNavigationTabs_ReturnValue; // 0x18(0x10)(ConstParm, ReferenceParm, HasGetValueTypeHash)
