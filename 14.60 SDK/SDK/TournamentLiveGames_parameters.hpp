...
public:
	...
	uint8                                        Pad_79BB[0x4];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	struct FFortTournamentDisplayInfo            K2Node_CustomEvent_TournamentDisplayInfo;          // 0x28(0x1A8)(None)
	struct FLinearColor                          K2Node_MakeStruct_LinearColor;                     // 0x1D0(0x10)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	bool                                         K2Node_Event_bIsLoading;                           // 0x1E8(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
};
