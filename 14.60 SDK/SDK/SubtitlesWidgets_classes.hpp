...
{
public:
	uint8                                        Pad_4C6B[0x8];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_4C6C[0x10];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_4C6F[0x10];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_4C71[0x18];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	struct FSubtitleFormat                       SubtitleFormat;                                    // 0x48(0x4)(NoDestructor, NativeAccessSpecifierPrivate)
	uint8                                        Pad_4C72[0x4];                                     // Fixing Size Of Struct [ Dumper-7 ]
