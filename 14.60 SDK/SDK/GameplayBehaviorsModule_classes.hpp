...
{
public:
	uint8                                        Pad_4D7E[0x14];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_4D7F[0x1C];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	TArray<class AActor*>                        RelevantActors;                                    // 0x60(0x10)(Edit, BlueprintVisible, ZeroConstructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	TArray<class UGameplayTask*>                 ActiveTasks;                                       // 0x70(0x10)(ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
{
public:
	TArray<struct FMontagePlaybackData>          ActivePlayback;                                    // 0x88(0x10)(ZeroConstructor, ContainsInstancedReference, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
public:
	...
	uint8                                        Pad_4D81[0x3];                                     // Fixing Size Of Struct [ Dumper-7 ]
