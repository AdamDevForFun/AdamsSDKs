...
public:
	...
	TArray<struct FFortItemQuantityPair>         ReturnIngredients;                                 // 0x8(0x10)(Parm, OutParm, HasGetValueTypeHash)
	TArray<struct FFortItemQuantityPair>         Ingredients;                                       // 0x18(0x10)(Edit, BlueprintVisible, HasGetValueTypeHash)
...
public:
	...
	TArray<struct FFortItemQuantityPair>         CallFunc_GetIngredients_ReturnIngredients;         // 0x8(0x10)(ReferenceParm, HasGetValueTypeHash)
};
...
{
public:
	TArray<class UFortWorldItem*>                ItemsAdded;                                        // 0x0(0x10)(BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ReferenceParm, HasGetValueTypeHash)
	TArray<class UFortWorldItem*>                ItemsRemoved;                                      // 0x10(0x10)(BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ReferenceParm, HasGetValueTypeHash)
};
...
{
public:
	TArray<struct FFortItemQuantityPair>         CallFunc_GetIngredients_ReturnIngredients;         // 0x0(0x10)(ReferenceParm, HasGetValueTypeHash)
};
...
public:
	...
	uint8                                        Pad_7359[0x6];                                     // Fixing Size After Last Property  [ Dumper-7 ]
