...
public:
	...
	uint8                                        BitPad_1F8 : 4;                                    // Fixing Bit-Field Size  [ Dumper-7 ]
	...
	uint8                                        Pad_265C[0x38];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_2660[0x80];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_268A[0x78];                                    // Fixing Size After Last Property  [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_268F[0x38];                                    // Fixing Size After Last Property  [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_2696[0x5C];                                    // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_269C[0x18];                                    // Fixing Size Of Struct [ Dumper-7 ]
