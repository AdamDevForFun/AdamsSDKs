...
public:
	...
	bool                                         CallFunc_CanShowLockerSlotType_ReturnValue;        // 0x18(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                        Pad_79CC[0x7];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	struct FAthenaCustomizationParams            K2Node_MakeStruct_AthenaCustomizationParams;       // 0x48(0x48)(None)
	int32                                        K2Node_CustomEvent_ButtonIndex;                    // 0x90(0x4)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	uint8                                        Pad_79CE[0x4];                                     // Fixing Size After Last Property  [ Dumper-7 ]
