...
{
public:
	TArray<struct FPropertyAccessCopy>           Copies;                                            // 0x0(0x10)(ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
};
...
public:
	...
	uint8                                        Pad_29FA[0x6];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	TArray<struct FPropertyAccessSegment>        PathSegments;                                      // 0x0(0x10)(ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	TArray<struct FPropertyAccessPath>           SrcPaths;                                          // 0x10(0x10)(ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	TArray<struct FPropertyAccessPath>           DestPaths;                                         // 0x20(0x10)(ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	struct FPropertyAccessCopyBatch              CopyBatches[0x4];                                  // 0x30(0x40)(NativeAccessSpecifierPrivate)
	TArray<struct FPropertyAccessIndirectionChain> SrcAccesses;                                       // 0x70(0x10)(ZeroConstructor, Transient, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	TArray<struct FPropertyAccessIndirectionChain> DestAccesses;                                      // 0x80(0x10)(ZeroConstructor, Transient, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	TArray<struct FPropertyAccessIndirection>    Indirections;                                      // 0x90(0x10)(ZeroConstructor, Transient, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	TArray<int32>                                EventAccessIndices;                                // 0xA0(0x10)(ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                        Pad_29FB[0x18];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
