...
public:
	...
	TArray<class AFortPawn*>                     RelevantPawns;                                     // 0x50(0x10)(Edit, BlueprintVisible, DisableEditOnTemplate, HasGetValueTypeHash)
	...
	TArray<class AFortPawn*>                     NearbyPawns;                                       // 0x68(0x10)(Edit, BlueprintVisible, DisableEditOnTemplate, HasGetValueTypeHash)
	...
	TArray<class AFortPawn*>                     CallFunc_GetFortPawnsInRange_OutFortPawns;         // 0x550(0x10)(ReferenceParm, HasGetValueTypeHash)
};
