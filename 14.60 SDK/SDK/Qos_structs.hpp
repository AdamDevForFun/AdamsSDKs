...
public:
	...
	uint8                                        Pad_1EC4[0x5];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	TArray<struct FQosPingServerInfo>            Servers;                                           // 0x28(0x10)(ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
...
public:
	...
	TArray<int32>                                PingResults;                                       // 0x40(0x10)(ZeroConstructor, Transient, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
public:
	...
	TArray<struct FDatacenterQosInstance>        DatacenterOptions;                                 // 0x30(0x10)(ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
