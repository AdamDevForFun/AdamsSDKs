...
public:
	...
	uint8                                        Pad_BBD[0xF];                                      // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_BC3[0x15];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	TMap<enum class ECommonGamepadType, struct FCommonInputTypeInfo> GamepadInputTypeInfoOverrides;                     // 0x188(0x50)(Edit, Protected, NativeAccessSpecifierProtected)
	struct FCommonInputTypeInfo                  GamepadInputTypeInfos[0x6];                        // 0x1D8(0x3F0)(Deprecated, Protected, NativeAccessSpecifierProtected)
	struct FCommonInputTypeInfo                  TouchInputTypeInfo;                                // 0x5C8(0xA8)(Edit, Protected, NativeAccessSpecifierProtected)
};
