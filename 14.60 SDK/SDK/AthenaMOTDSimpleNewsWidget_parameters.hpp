...
public:
	...
	struct FAthenaNewsEntry                      K2Node_Event_NewsEntry;                            // 0x18(0x200)(ConstParm)
	struct FColor                                K2Node_Select_Default_1;                           // 0x218(0x4)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FColor                                K2Node_Select_Default_2;                           // 0x21C(0x4)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FColor                                K2Node_Select_Default_3;                           // 0x220(0x4)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
