...
struct UBP_TimeSynthTrackComponent_Gasket_Wasabi_C_HandleMixState_Params
{
public:
...
struct UBP_TimeSynthTrackComponent_Gasket_Wasabi_C_GetRemainingEventCooldown_Params
{
public:
...
struct UBP_TimeSynthTrackComponent_Gasket_Wasabi_C_OnDataTrackerUpdate_Params
{
public:
	...
	float                                        CallFunc_GetWorldDeltaSeconds_ReturnValue_1;       // 0x14(0x4)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                         CallFunc_Less_FloatFloat_ReturnValue;              // 0x18(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                        Pad_7745[0x3];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	class UFortGameplayDataTrackerComponent*     CallFunc_GetDataTrackerComponent_DataTrackerComponent_1; // 0x28(0x8)(ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	float                                        CallFunc_GetEventValue_ReturnValue_1;              // 0x30(0x4)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                         CallFunc_Less_FloatFloat_ReturnValue_1;            // 0x34(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                        Pad_7749[0x3];                                     // Fixing Size After Last Property  [ Dumper-7 ]
