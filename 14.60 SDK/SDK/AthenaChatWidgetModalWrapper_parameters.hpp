...
struct UAthenaChatWidgetModalWrapper_C_FocusChat_Params
{
public:
	class UChatContainer_C*                      K2Node_DynamicCast_AsChat_Container;               // 0x0(0x8)(ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
