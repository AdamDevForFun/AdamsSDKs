...
struct UVBucksStoreScreen_C_ApplyMobileLayout_Params
{
public:
	class UOverlaySlot*                          CallFunc_SlotAsOverlaySlot_ReturnValue;            // 0x0(0x8)(ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};

// 0x8 (0x8 - 0x0)
// Function VBucksStoreScreen.VBucksStoreScreen_C.BP_GetDesiredFocusTarget
struct UVBucksStoreScreen_C_BP_GetDesiredFocusTarget_Params
{
public:
...
struct UVBucksStoreScreen_C_GetVisibilityByChildrenPresence_Params
{
public:
...
struct UVBucksStoreScreen_C_PlayEquippedLockerMusic_Params
{
public:
...
struct UVBucksStoreScreen_C_HandleBack_Params
{
public:
...
struct UVBucksStoreScreen_C_HandleRedeem_Params
{
public:
...
struct UVBucksStoreScreen_C_UpdateCurrencyNotification_Params
{
public:
	enum class ESlateVisibility                  Temp_byte_Variable;                                // 0x0(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	enum class ESlateVisibility                  Temp_byte_Variable_1;                              // 0x1(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                         Temp_bool_Variable;                                // 0x2(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                        Pad_7579[0x1];                                     // Fixing Size After Last Property  [ Dumper-7 ]
...
struct UVBucksStoreScreen_C_OnUpdateOtherPlatformMTXMessage_Params
{
public:
...
struct UVBucksStoreScreen_C_PreConstruct_Params
{
public:
...
struct UVBucksStoreScreen_C_ExecuteUbergraph_VBucksStoreScreen_Params
{
public:
	...
	bool                                         K2Node_Event_HasOtherPlatformCurrency;             // 0x12(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                        Pad_757E[0x5];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_757F[0x6];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	class UStore_BannerMessage_C*                K2Node_DynamicCast_AsStore_Banner_Message;         // 0x38(0x8)(ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
