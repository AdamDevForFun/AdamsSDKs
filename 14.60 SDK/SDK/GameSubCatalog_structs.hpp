...
public:
	...
	TArray<struct FCatalogOfferRequirement>      PurchaseRequirements;                              // 0x18(0x10)(ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
...
public:
	...
	uint8                                        Pad_53DD[0x7];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	TArray<struct FCatalogDynamicBundleItem>     BundleItems;                                       // 0x28(0x10)(Edit, ZeroConstructor, DisableEditOnInstance, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
...
public:
	...
	TArray<struct FCatalogKeyValue>              MetaInfo;                                          // 0x20(0x10)(Edit, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	TArray<struct FCatalogItemPrice>             Prices;                                            // 0x38(0x10)(Edit, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	TArray<class FString>                        Categories;                                        // 0x90(0x10)(Edit, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	TArray<struct FItemQuantity>                 ItemGrants;                                        // 0x200(0x10)(ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TArray<struct FCatalogOfferRequirement>      Requirements;                                      // 0x210(0x10)(ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	TArray<class FString>                        DenyItemTemplateIds;                               // 0x250(0x10)(ZeroConstructor, Deprecated, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
};
...
public:
	...
	TArray<struct FCatalogOffer>                 CatalogEntries;                                    // 0x10(0x10)(ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
...
public:
	...
	TArray<struct FStorefront>                   Storefronts;                                       // 0x10(0x10)(ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
...
public:
	...
	TArray<class FString>                        ReceiverAccountIds;                                // 0x40(0x10)(ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
public:
	...
	uint8                                        Pad_53F1[0x8];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_53F2[0x10];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
