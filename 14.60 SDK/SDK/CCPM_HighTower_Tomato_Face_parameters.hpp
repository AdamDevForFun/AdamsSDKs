...
struct ACCPM_HighTower_Tomato_Face_C_CreateMIDs_Params
{
public:
	...
	class UMaterialInstanceDynamic*              CallFunc_CreateDynamicMaterialInstance_ReturnValue_2; // 0x70(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};

// 0x10 (0x10 - 0x0)
// Function CCPM_HighTower_Tomato_Face.CCPM_HighTower_Tomato_Face_C.UserConstructionScript
struct ACCPM_HighTower_Tomato_Face_C_UserConstructionScript_Params
{
public:
...
struct ACCPM_HighTower_Tomato_Face_C_ExecuteUbergraph_CCPM_HighTower_Tomato_Face_Params
{
public:
