...
public:
	...
	uint8                                        Pad_69E4[0x5];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_69E5[0x6];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	TArray<class AActor*>                        CallFunc_GetActorsFromTargetData_ReturnValue;      // 0x1D8(0x10)(ReferenceParm, HasGetValueTypeHash)
	...
	uint8                                        Pad_69EB[0x2];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	TArray<struct FActiveGameplayEffectHandle>   CallFunc_ApplyGameplayEffectContainer_ReturnValue; // 0x220(0x10)(ConstParm, ReferenceParm, HasGetValueTypeHash)
