...
struct UGCN_HighTower_Tomato_RepulsorCannon_StructureHit_C_SpawnSoundIndicators_Params
{
public:
	...
	struct FGameplayCueParameters                Params;                                            // 0x8(0xB8)(BlueprintVisible, BlueprintReadOnly, Parm, ContainsInstancedReference)
	TArray<enum class EFortTeamAffiliation>      K2Node_MakeArray_Array;                            // 0xC0(0x10)(ReferenceParm, HasGetValueTypeHash)
	...
	uint8                                        CallFunc_GetActorTeam_ReturnValue;                 // 0x195(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
...
struct UGCN_HighTower_Tomato_RepulsorCannon_StructureHit_C_OnBurstGeneric_Params
{
public:
	...
	class AFortWaterBodyActor*                   K2Node_DynamicCast_AsFort_Water_Body_Actor;        // 0x1C0(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	class ACharacter*                            K2Node_DynamicCast_AsCharacter;                    // 0x1D0(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	class UDecalComponent*                       CallFunc_SpawnDecalAtLocation_ReturnValue;         // 0x1F8(0x8)(ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	class UFXSystemComponent*                    CallFunc_Array_Get_Item;                           // 0x208(0x8)(ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FHitResult                            CallFunc_K2_SetWorldRotation_SweepHitResult;       // 0x210(0x8C)(IsPlainOldData, NoDestructor, ContainsInstancedReference)
	struct FHitResult                            CallFunc_K2_SetWorldLocation_SweepHitResult;       // 0x29C(0x8C)(IsPlainOldData, NoDestructor, ContainsInstancedReference)
};
