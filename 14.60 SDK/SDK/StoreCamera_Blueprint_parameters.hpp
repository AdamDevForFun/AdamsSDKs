...
public:
	...
	TArray<class AStorePinataMaster_Parent_C*>   CallFunc_GetAllActorsOfClass_OutActors;            // 0xE0(0x10)(ReferenceParm, HasGetValueTypeHash)
	...
	TArray<class AStoreCardReveal_Parent_C*>     CallFunc_GetAllActorsOfClass_OutActors_1;          // 0x100(0x10)(ReferenceParm, HasGetValueTypeHash)
	...
	TArray<class ATVPostProcessBP_C*>            CallFunc_GetAllActorsOfClass_OutActors_2;          // 0x120(0x10)(ReferenceParm, HasGetValueTypeHash)
