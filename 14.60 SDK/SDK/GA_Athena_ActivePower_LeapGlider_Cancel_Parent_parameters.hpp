...
struct UGA_Athena_ActivePower_LeapGlider_Cancel_Parent_C_ExecuteUbergraph_GA_Athena_ActivePower_LeapGlider_Cancel_Parent_Params
{
public:
	...
	bool                                         CallFunc_IsSkydiving_ReturnValue;                  // 0x29(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                        Pad_5D66[0x6];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	TScriptInterface<class IGameplayTagAssetInterface> CallFunc_HasAnyMatchingGameplayTags_self_CastInput; // 0x48(0x10)(ZeroConstructor, IsPlainOldData, NoDestructor)
	bool                                         CallFunc_HasAnyMatchingGameplayTags_ReturnValue;   // 0x58(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
