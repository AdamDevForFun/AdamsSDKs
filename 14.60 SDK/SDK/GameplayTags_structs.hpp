...
{
public:
	uint8                                        Pad_51F4[0x10];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_51F5[0x1];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_51F6[0x50];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_51F8[0x7];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
