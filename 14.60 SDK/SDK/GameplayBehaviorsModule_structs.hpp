...
public:
	...
	uint8                                        Pad_4D84[0x30];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	TArray<class UGameplayBehavior*>             Behaviors;                                         // 0x0(0x10)(ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
