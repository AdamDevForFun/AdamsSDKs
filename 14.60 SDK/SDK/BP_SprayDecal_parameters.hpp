...
public:
	...
	uint8                                        Pad_44B5[0x5];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	TArray<enum class EObjectTypeQuery>          K2Node_MakeArray_Array_1;                          // 0x100(0x10)(ConstParm, ReferenceParm, HasGetValueTypeHash)
	...
	TArray<class AActor*>                        CallFunc_BoxOverlapActors_OutActors;               // 0x120(0x10)(ReferenceParm, HasGetValueTypeHash)
...
public:
	...
	uint8                                        Pad_44D0[0xC];                                     // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_44E2[0x6];                                     // Fixing Size After Last Property  [ Dumper-7 ]
