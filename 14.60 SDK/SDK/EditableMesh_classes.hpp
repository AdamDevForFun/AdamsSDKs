...
public:
	...
	uint8                                        Pad_2C36[0x9C];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_2CB4[0x390];                                   // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_2CB6[0x148];                                   // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_2CB7[0x1E4];                                   // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_2CC0[0xA4];                                    // Fixing Size Of Struct [ Dumper-7 ]
