...
{
public:
	uint8                                        Pad_53AF[0xAC];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_53B0[0x18];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_53B1[0x28];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_53B2[0x30];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
