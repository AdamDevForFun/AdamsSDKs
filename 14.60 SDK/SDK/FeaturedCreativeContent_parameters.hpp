...
{
public:
	TArray<class FString>                        MediaURLs;                                         // 0x0(0x10)(ConstParm, BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ReferenceParm, HasGetValueTypeHash)
	TArray<struct FCreativeAdData>               AdMetadata;                                        // 0x10(0x10)(ConstParm, BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ReferenceParm, HasGetValueTypeHash)
};
...
public:
	...
	TArray<class FString>                        K2Node_Event_MediaURLs;                            // 0x8(0x10)(ConstParm, ReferenceParm, HasGetValueTypeHash)
	TArray<struct FCreativeAdData>               K2Node_Event_AdMetadata;                           // 0x18(0x10)(ConstParm, ReferenceParm, HasGetValueTypeHash)
