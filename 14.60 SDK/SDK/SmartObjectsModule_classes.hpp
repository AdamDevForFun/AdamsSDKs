...
public:
	...
	uint8                                        Pad_4D68[0x20];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_4D6F[0x8];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_4D70[0xF];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_4D72[0xA8];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	uint8                                        BitPad_2F6 : 1;                                    // Fixing Bit-Field Size  [ Dumper-7 ]
	...
	uint8                                        BitPad_2F7 : 6;                                    // Fixing Bit-Field Size  [ Dumper-7 ]
	...
	uint8                                        Pad_4D74[0x8];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_4D75[0xF];                                     // Fixing Size Of Struct [ Dumper-7 ]
