...
struct UGCN_HighTower_Vertigo_Punch_Hit_World_C_OnBurst_Params
{
public:
	...
	uint8                                        Pad_7804[0x6];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	class UForceFeedbackComponent*               CallFunc_SpawnForceFeedbackAttached_ReturnValue;   // 0x108(0x8)(ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
