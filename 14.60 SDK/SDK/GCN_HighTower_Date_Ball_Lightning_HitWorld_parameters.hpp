...
struct UGCN_HighTower_Date_Ball_Lightning_HitWorld_C_OnBurst_Params
{
public:
	...
	struct FHitResult                            CallFunc_K2_SetRelativeRotation_SweepHitResult;    // 0x1F0(0x8C)(IsPlainOldData, NoDestructor, ContainsInstancedReference)
};
