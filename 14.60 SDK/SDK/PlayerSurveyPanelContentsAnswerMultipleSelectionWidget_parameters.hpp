...
public:
	...
	uint8                                        Pad_65FF[0x2];                                     // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	...
	TArray<class UUserWidget*>                   CallFunc_GetAllEntries_ReturnValue;                // 0x18(0x10)(ConstParm, ReferenceParm, ContainsInstancedReference, HasGetValueTypeHash)
...
{
public:
	TArray<struct FFortPlayerSurveyAnswerMultipleSelectionSingleAnswer> AnswerChoices;                                     // 0x0(0x10)(BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ReferenceParm, HasGetValueTypeHash)
