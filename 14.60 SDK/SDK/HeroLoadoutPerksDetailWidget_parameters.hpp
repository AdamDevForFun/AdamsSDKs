...
{
public:
	TSet<class UWidget*>                         PerkWidgetsToShow;                                 // 0x0(0x50)(Edit, BlueprintVisible, ContainsInstancedReference)
...
public:
	...
	uint8                                        Pad_6B17[0x6];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	TArray<class UFortAbilityKit*>               CallFunc_GetAbilityKitsForClassPerks_ReturnValue;  // 0xB8(0x10)(ReferenceParm, HasGetValueTypeHash)
