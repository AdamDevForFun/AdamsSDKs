...
class UBP_TimeSynthTrackComponent_Gasket_Mang_C : public UBP_TimeSynthTrackComponent_DataTracker_C
{
public:
	...
	struct FGameplayTag                          EventTag_Unaware;                                  // 0x218(0x8)(Edit, BlueprintVisible, DisableEditOnInstance, NoDestructor, HasGetValueTypeHash)
	struct FGameplayTag                          EventTag_Alerted;                                  // 0x220(0x8)(Edit, BlueprintVisible, DisableEditOnInstance, NoDestructor, HasGetValueTypeHash)
	struct FGameplayTag                          EventTag_Aggressive;                               // 0x228(0x8)(Edit, BlueprintVisible, DisableEditOnInstance, NoDestructor, HasGetValueTypeHash)
