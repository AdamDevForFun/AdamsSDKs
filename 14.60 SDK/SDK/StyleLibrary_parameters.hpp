...
public:
	...
	TArray<struct FLinearColor>                  DifficultyColors;                                  // 0x28(0x10)(Edit, BlueprintVisible, HasGetValueTypeHash)
	TArray<struct FLinearColor>                  K2Node_MakeArray_Array;                            // 0x38(0x10)(ReferenceParm, HasGetValueTypeHash)
...
public:
	...
	TArray<class FText>                          DifficultyColorNames;                              // 0x48(0x10)(Edit, BlueprintVisible, HasGetValueTypeHash)
	TArray<class FText>                          DifficultyTooltips;                                // 0x58(0x10)(Edit, BlueprintVisible, HasGetValueTypeHash)
	TArray<int32>                                DifficultyIndices;                                 // 0x68(0x10)(Edit, BlueprintVisible, HasGetValueTypeHash)
	TArray<struct FLinearColor>                  DifficultyColors;                                  // 0x78(0x10)(Edit, BlueprintVisible, HasGetValueTypeHash)
	TArray<class FName>                          RowNames;                                          // 0x88(0x10)(Edit, BlueprintVisible, HasGetValueTypeHash)
	...
	TArray<float>                                SPCutoffValues;                                    // 0xD8(0x10)(Edit, BlueprintVisible, HasGetValueTypeHash)
	...
	TArray<float>                                K2Node_MakeArray_Array;                            // 0x150(0x10)(ReferenceParm, HasGetValueTypeHash)
	TArray<class FName>                          K2Node_MakeArray_Array_1;                          // 0x160(0x10)(ReferenceParm, HasGetValueTypeHash)
	...
	TArray<struct FLinearColor>                  K2Node_MakeArray_Array_2;                          // 0x178(0x10)(ReferenceParm, HasGetValueTypeHash)
	...
	TArray<int32>                                K2Node_MakeArray_Array_3;                          // 0x198(0x10)(ReferenceParm, HasGetValueTypeHash)
	...
	uint8                                        Pad_7344[0x2];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	TArray<class FText>                          K2Node_MakeArray_Array_4;                          // 0x1C8(0x10)(ReferenceParm, HasGetValueTypeHash)
	TArray<class FText>                          K2Node_MakeArray_Array_5;                          // 0x1D8(0x10)(ReferenceParm, HasGetValueTypeHash)
};
