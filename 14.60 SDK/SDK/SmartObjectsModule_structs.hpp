...
public:
	...
	TArray<struct FSmartObjectSlot>              Slots;                                             // 0xB0(0x10)(Edit, ZeroConstructor, DisableEditOnInstance, ContainsInstancedReference, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
public:
	...
	uint8                                        Pad_4D77[0x4];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_4D78[0x8];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	struct FSmartObjectExecutionSlot             Slot;                                              // 0x8(0x20)(NoDestructor, NativeAccessSpecifierPublic)
	uint8                                        Pad_4D79[0x8];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	TArray<struct FSmartObjectUse>               ActiveUses;                                        // 0x18(0x10)(ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
...
{
public:
	uint8                                        Pad_4D7A[0x4];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
