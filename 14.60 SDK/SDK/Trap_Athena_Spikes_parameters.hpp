...
public:
	...
	TArray<class AFortPlayerController*>         CallFunc_GetLocalFortPlayerControllers_ReturnValue; // 0x8(0x10)(ReferenceParm, HasGetValueTypeHash)
...
public:
	...
	uint8                                        Pad_6C00[0xA];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_6C01[0x4];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	TMap<class FName, struct FParameterNameMapping> K2Node_MakeMap_Map;                                // 0x468(0x50)(ConstParm)
	...
	uint8                                        Pad_6C04[0x5];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_6C05[0x5];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	TArray<struct FParticleSysParam>             CallFunc_MapParticleInstanceParamNames_ReturnValue; // 0x7C8(0x10)(ReferenceParm, HasGetValueTypeHash)
	...
	TArray<enum class EFortTeamAffiliation>      K2Node_MakeArray_Array_1;                          // 0x800(0x10)(ReferenceParm, HasGetValueTypeHash)
