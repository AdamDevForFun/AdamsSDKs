...
public:
	...
	TArray<struct FTransform>                    Transforms;                                        // 0x8(0x10)(ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TArray<struct FLiveLinkCurveElement>         Curves;                                            // 0x18(0x10)(ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
{
public:
	uint8                                        Pad_549B[0x1];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
