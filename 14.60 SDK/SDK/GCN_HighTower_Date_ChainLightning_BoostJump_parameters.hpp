...
struct UGCN_HighTower_Date_ChainLightning_BoostJump_C_OnBurst_Params
{
public:
	...
	bool                                         CallFunc_Array_IsValidIndex_ReturnValue;           // 0xF8(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
	...
	class USkeletalMeshComponent*                CallFunc_GetSkeletalMeshForPartType_ReturnValue;   // 0x110(0x8)(ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
