...
{
public:
	TArray<class UMaterialInstanceDynamic*>      CallFunc_External_Mesh_Masked_Setup_Corrected_Mid_Array; // 0x0(0x10)(ReferenceParm, HasGetValueTypeHash)
};
...
{
public:
	TArray<class USkeletalMeshComponent*>        External_MEsh_Component_Array;                     // 0x0(0x10)(BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ReferenceParm, ContainsInstancedReference, HasGetValueTypeHash)
	TArray<class UMaterialInstanceDynamic*>      Corrected_Mid_Array;                               // 0x10(0x10)(Parm, OutParm, HasGetValueTypeHash)
	...
	TArray<class UMaterialInstanceDynamic*>      MID_Array_MaskedSetup;                             // 0x28(0x10)(Edit, BlueprintVisible, HasGetValueTypeHash)
...
public:
	...
	uint8                                        Pad_5035[0xC];                                     // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	...
	TArray<class USkeletalMeshComponent*>        K2Node_MakeArray_Array;                            // 0x20(0x10)(ReferenceParm, ContainsInstancedReference, HasGetValueTypeHash)
...
{
public:
	TArray<class UMaterialInstanceDynamic*>      MID_Array;                                         // 0x0(0x10)(ConstParm, BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ReferenceParm, HasGetValueTypeHash)
	TArray<class USkeletalMeshComponent*>        External_MEsh_Component_Array;                     // 0x10(0x10)(ConstParm, BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ReferenceParm, ContainsInstancedReference, HasGetValueTypeHash)
};
...
public:
	...
	TArray<class UMaterialInstanceDynamic*>      K2Node_CustomEvent_MID_Array;                      // 0x30(0x10)(ConstParm, ReferenceParm, HasGetValueTypeHash)
	TArray<class USkeletalMeshComponent*>        K2Node_CustomEvent_External_MEsh_Component_Array;  // 0x40(0x10)(ConstParm, ReferenceParm, ContainsInstancedReference, HasGetValueTypeHash)
	...
	TArray<class UMaterialInstanceDynamic*>      CallFunc_External_Mesh_Masked_Setup_Corrected_Mid_Array; // 0x138(0x10)(ReferenceParm, HasGetValueTypeHash)
	...
	TArray<class UMaterialInterface*>            CallFunc_GetMaterials_ReturnValue;                 // 0x158(0x10)(ReferenceParm, HasGetValueTypeHash)
