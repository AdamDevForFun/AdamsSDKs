...
{
public:
	uint8                                        Pad_2EC1[0x48];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_2EC2[0x8];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_2EC7[0x7];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_2ED0[0xC];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_2ED4[0xC];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_2EDC[0xC];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_2EE6[0x10];                                    // Fixing Size After Last Property  [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_2EEC[0x20];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_2F0F[0x10];                                    // Fixing Size Of Struct [ Dumper-7 ]
