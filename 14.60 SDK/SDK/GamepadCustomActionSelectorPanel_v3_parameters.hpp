...
public:
	...
	class FString                                CallFunc_GetCustomGamepadInputPresetName_ReturnValue; // 0x48(0x10)(ZeroConstructor, HasGetValueTypeHash)
	...
	class UFortInputData*                        CallFunc_GetFortInputDataForBlueprint_ReturnValue; // 0x68(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                         CallFunc_IsValid_ReturnValue;                      // 0x70(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                        Pad_76CD[0x7];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	class FText                                  CallFunc_GetScreenLabel_ReturnValue;               // 0x78(0x18)(None)
	class UGamepadKeyTextButton_C*               CallFunc_Create_ReturnValue;                       // 0x90(0x8)(ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
{
public:
	TArray<class UFortOptionsMenuInputData*>     InputData;                                         // 0x0(0x10)(ConstParm, BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ReferenceParm, HasGetValueTypeHash)
};
...
public:
	...
	TArray<class UFortOptionsMenuInputData*>     K2Node_CustomEvent_InputData;                      // 0x8(0x10)(ConstParm, ReferenceParm, HasGetValueTypeHash)
