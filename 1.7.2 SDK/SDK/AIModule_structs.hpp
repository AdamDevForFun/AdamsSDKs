...
{
public:
	uint8                                        Pad_99C[0x8];                                      // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_9A0[0x38];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_9BC[0x28];                                     // Fixing Size After Last Property  [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_9CB[0x10];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_9CC[0x14];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_9CD[0xC];                                      // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_9D2[0x3];                                      // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_9D7[0x1B8];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_9D9[0x50];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
