...
class UClass* UShowFriendCodesSelection_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("ShowFriendCodesSelection_C");

	return Clss;
}


// ShowFriendCodesSelection_C ShowFriendCodesSelection.Default__ShowFriendCodesSelection_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UShowFriendCodesSelection_C* UShowFriendCodesSelection_C::GetDefaultObj()
{
	static class UShowFriendCodesSelection_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UShowFriendCodesSelection_C*>(UShowFriendCodesSelection_C::StaticClass()->DefaultObject);
