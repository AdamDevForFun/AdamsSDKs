...
public:
	...
	struct FSlateBrush                           CallFunc_GetItemDefinitionSmallPreviewImageBrush_ReturnValue; // 0x68(0x90)(None)
	...
	class FText                                  CallFunc_GetTrapAttachTypeName_ReturnValue;        // 0x1C8(0x18)(None)
	...
	class FText                                  CallFunc_Format_ReturnValue2;                      // 0x2C0(0x18)(None)
	...
	class FText                                  K2Node_Select8_Default;                            // 0x2E8(0x18)(None)
