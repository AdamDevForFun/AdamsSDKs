...
public:
	...
	class FText                                  Temp_text_Variable12;                              // 0x128(0x18)(None)
	class FText                                  Temp_text_Variable13;                              // 0x140(0x18)(None)
	class FText                                  Temp_text_Variable14;                              // 0x158(0x18)(None)
	class FText                                  Temp_text_Variable15;                              // 0x170(0x18)(None)
	class FText                                  Temp_text_Variable16;                              // 0x188(0x18)(None)
	class FText                                  Temp_text_Variable17;                              // 0x1A0(0x18)(None)
...
public:
	...
	uint8                                        Pad_3BBB[0x6];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	class FText                                  CallFunc_GetEmptyText_ReturnValue;                 // 0x188(0x18)(None)
	class FText                                  CallFunc_GetTertiaryCategory_ItemCategoryText;     // 0x1A0(0x18)(None)
	struct FSlateBrush                           CallFunc_GetTertiaryCategory_ItemCategoryBrush;    // 0x1B8(0x90)(None)
	...
	class FText                                  CallFunc_GetDisplayName_ReturnValue;               // 0x2B0(0x18)(None)
	...
	class FText                                  CallFunc_TextTrimPrecedingAndTrailing_ReturnValue; // 0x2E8(0x18)(None)
	...
	class FText                                  K2Node_Select2_Default;                            // 0x368(0x18)(None)
};
...
public:
	...
	enum class EFortItemType                     CallFunc_GetType_ReturnValue;                      // 0x80(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
	bool                                         CallFunc_EqualEqual_ByteByte_ReturnValue;          // 0x81(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
	bool                                         CallFunc_EqualEqual_ByteByte_ReturnValue2;         // 0x82(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                        Pad_3BBF[0x5];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	struct FSlateColor                           K2Node_MakeStruct_SlateColor;                      // 0x88(0x28)(None)
	bool                                         CallFunc_EqualEqual_ByteByte_ReturnValue3;         // 0xB0(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
	bool                                         CallFunc_BooleanOR_ReturnValue;                    // 0xB1(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
	bool                                         CallFunc_BooleanOR_ReturnValue2;                   // 0xB2(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                        Pad_3BC0[0x5];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	struct FFortRarityItemData                   CallFunc_BPGetRarityData_ReturnValue;              // 0xB8(0x80)(None)
	class FText                                  CallFunc_Get_Card_Name_Text_ReturnValue;           // 0x138(0x18)(None)
	enum class ESlateVisibility                  Temp_byte_Variable;                                // 0x150(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                        Pad_3BC1[0x3];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	struct FLinearColor                          K2Node_MakeStruct_LinearColor;                     // 0x154(0x10)(IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	enum class ESlateVisibility                  Temp_byte_Variable2;                               // 0x164(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
	bool                                         Temp_bool_Variable;                                // 0x165(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
	enum class ESlateVisibility                  K2Node_Select_Default;                             // 0x166(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                        Pad_3BC2[0x1];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	class FText                                  CallFunc_Get_Type_Text_outText;                    // 0x168(0x18)(None)
	struct FFormatArgumentData                   K2Node_MakeStruct_FormatArgumentData;              // 0x180(0x40)(HasGetValueTypeHash)
	struct FFortRarityItemData                   CallFunc_BPGetRarityData_ReturnValue2;             // 0x1C0(0x80)(None)
	struct FSlateColor                           K2Node_MakeStruct_SlateColor2;                     // 0x240(0x28)(None)
	struct FFormatArgumentData                   K2Node_MakeStruct_FormatArgumentData2;             // 0x268(0x40)(HasGetValueTypeHash)
