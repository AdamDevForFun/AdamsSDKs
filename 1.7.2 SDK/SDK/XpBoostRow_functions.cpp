...
class UClass* UXpBoostRow_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("XpBoostRow_C");

	return Clss;
}


// XpBoostRow_C XpBoostRow.Default__XpBoostRow_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UXpBoostRow_C* UXpBoostRow_C::GetDefaultObj()
{
	static class UXpBoostRow_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UXpBoostRow_C*>(UXpBoostRow_C::StaticClass()->DefaultObject);
