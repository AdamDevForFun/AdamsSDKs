...
class UClass* UItemTransformRequiredItems_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("ItemTransformRequiredItems_C");

	return Clss;
}


// ItemTransformRequiredItems_C ItemTransformRequiredItems.Default__ItemTransformRequiredItems_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UItemTransformRequiredItems_C* UItemTransformRequiredItems_C::GetDefaultObj()
{
	static class UItemTransformRequiredItems_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UItemTransformRequiredItems_C*>(UItemTransformRequiredItems_C::StaticClass()->DefaultObject);
