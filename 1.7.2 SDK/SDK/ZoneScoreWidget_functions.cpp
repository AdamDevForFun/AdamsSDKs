...
class UClass* UZoneScoreWidget_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("ZoneScoreWidget_C");

	return Clss;
}


// ZoneScoreWidget_C ZoneScoreWidget.Default__ZoneScoreWidget_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UZoneScoreWidget_C* UZoneScoreWidget_C::GetDefaultObj()
{
	static class UZoneScoreWidget_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UZoneScoreWidget_C*>(UZoneScoreWidget_C::StaticClass()->DefaultObject);
...
// struct FFortPlayerScoreReport      CallFunc_Array_Get_Item                                          (None)
