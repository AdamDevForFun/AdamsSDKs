...
public:
	...
	uint8                                        Pad_25B9[0x4];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	struct FGameplayTagContainer                 K2Node_HandleMissionEvent_ObjectiveHandle;         // 0x18(0x20)(None)
	...
	struct FGameplayTagContainer                 K2Node_HandleMissionEvent_GameplayTags;            // 0x80(0x20)(None)
	...
	struct FGameplayTagContainer                 K2Node_HandleMissionEvent_ObjectiveHandle2;        // 0x148(0x20)(None)
	...
	struct FGameplayTagContainer                 K2Node_HandleMissionEvent_GameplayTags2;           // 0x1B0(0x20)(None)
