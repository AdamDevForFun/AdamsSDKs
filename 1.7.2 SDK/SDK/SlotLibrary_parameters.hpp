...
public:
	...
	class FText                                  CallFunc_GetAttributeDisplayName_ReturnValue;      // 0x120(0x18)(None)
...
public:
	...
	class FText                                  CallFunc_GetAttributeDescription_ReturnValue;      // 0x100(0x18)(None)
	class FText                                  CallFunc_Get_Attribute_Modifier_Header_Text_ReturnValue; // 0x118(0x18)(None)
	...
	class FText                                  Temp_text_Variable2;                               // 0x1F0(0x18)(None)
	...
	class FText                                  K2Node_Select3_Default;                            // 0x220(0x18)(None)
...
public:
	...
	struct FGameplayTagContainer                 CallFunc_MakeGameplayTagContainerFromArray_ReturnValue2; // 0x128(0x20)(None)
	struct FGameplayTagContainer                 CallFunc_MakeGameplayTagContainerFromArray_ReturnValue3; // 0x148(0x20)(None)
...
{
public:
	struct FFortMultiSizeBrush                   MultiMinussize_Brush;                              // 0x0(0x360)(Parm)
	...
	struct FSlateBrush                           K2Node_MakeStruct_SlateBrush;                      // 0x400(0x90)(None)
	...
	struct FSlateBrush                           K2Node_Select_Default;                             // 0x498(0x90)(None)
};
