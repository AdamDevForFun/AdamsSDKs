...
class UClass* UOptionsMenuSlider_Light_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("OptionsMenuSlider_Light_C");

	return Clss;
}


// OptionsMenuSlider_Light_C OptionsMenuSlider_Light.Default__OptionsMenuSlider_Light_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UOptionsMenuSlider_Light_C* UOptionsMenuSlider_Light_C::GetDefaultObj()
{
	static class UOptionsMenuSlider_Light_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UOptionsMenuSlider_Light_C*>(UOptionsMenuSlider_Light_C::StaticClass()->DefaultObject);
