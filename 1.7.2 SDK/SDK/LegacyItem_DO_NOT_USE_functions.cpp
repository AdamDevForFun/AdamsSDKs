...
class UClass* ULegacyItem_DO_NOT_USE_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("LegacyItem_DO_NOT_USE_C");

	return Clss;
}


// LegacyItem_DO_NOT_USE_C LegacyItem_DO_NOT_USE.Default__LegacyItem_DO_NOT_USE_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class ULegacyItem_DO_NOT_USE_C* ULegacyItem_DO_NOT_USE_C::GetDefaultObj()
{
	static class ULegacyItem_DO_NOT_USE_C* Default = nullptr;

	if (!Default)
		Default = static_cast<ULegacyItem_DO_NOT_USE_C*>(ULegacyItem_DO_NOT_USE_C::StaticClass()->DefaultObject);
...
// class FText                        CallFunc_GetSecondaryCategory_ItemCategoryText2                  (None)
// struct FSlateBrush                 CallFunc_GetSecondaryCategory_ItemCategoryBrush2                 (None)
...
// bool                               K2Node_DynamicCast_bSuccess                                      (ZeroConstructor, IsPlainOldData, NoDestructor)
// struct FGameplayTagContainer       CallFunc_IsActivatable_FailureReason                             (None)
