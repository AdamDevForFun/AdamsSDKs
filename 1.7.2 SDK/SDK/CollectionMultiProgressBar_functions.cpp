...
class UClass* UCollectionMultiProgressBar_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("CollectionMultiProgressBar_C");

	return Clss;
}


// CollectionMultiProgressBar_C CollectionMultiProgressBar.Default__CollectionMultiProgressBar_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UCollectionMultiProgressBar_C* UCollectionMultiProgressBar_C::GetDefaultObj()
{
	static class UCollectionMultiProgressBar_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UCollectionMultiProgressBar_C*>(UCollectionMultiProgressBar_C::StaticClass()->DefaultObject);
