...
class UClass* UHordeWaveModifiersWidget_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("HordeWaveModifiersWidget_C");

	return Clss;
}


// HordeWaveModifiersWidget_C HordeWaveModifiersWidget.Default__HordeWaveModifiersWidget_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UHordeWaveModifiersWidget_C* UHordeWaveModifiersWidget_C::GetDefaultObj()
{
	static class UHordeWaveModifiersWidget_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UHordeWaveModifiersWidget_C*>(UHordeWaveModifiersWidget_C::StaticClass()->DefaultObject);
