...
class UClass* UCollectionBookPageListWidget_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("CollectionBookPageListWidget_C");

	return Clss;
}


// CollectionBookPageListWidget_C CollectionBookPageListWidget.Default__CollectionBookPageListWidget_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UCollectionBookPageListWidget_C* UCollectionBookPageListWidget_C::GetDefaultObj()
{
	static class UCollectionBookPageListWidget_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UCollectionBookPageListWidget_C*>(UCollectionBookPageListWidget_C::StaticClass()->DefaultObject);
