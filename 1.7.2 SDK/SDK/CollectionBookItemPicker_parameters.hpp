...
public:
	...
	class FText                                  CallFunc_Get_Type_Text_Type;                       // 0x18(0x18)(None)
	...
	struct FCommonInputActionData                CallFunc_GetDataTableRowFromName_OutRow;           // 0xE0(0x2D0)(None)
	...
	struct FConfirmationDialogAction             K2Node_MakeStruct_ConfirmationDialogAction;        // 0x3B8(0xD0)(None)
	...
	class FText                                  CallFunc_Get_Type_Text_Type2;                      // 0x508(0x18)(None)
	...
	class FText                                  CallFunc_Format_ReturnValue2;                      // 0x578(0x18)(None)
};
