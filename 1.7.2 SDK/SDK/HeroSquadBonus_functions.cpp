...
class UClass* UHeroSquadBonus_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("HeroSquadBonus_C");

	return Clss;
}


// HeroSquadBonus_C HeroSquadBonus.Default__HeroSquadBonus_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UHeroSquadBonus_C* UHeroSquadBonus_C::GetDefaultObj()
{
	static class UHeroSquadBonus_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UHeroSquadBonus_C*>(UHeroSquadBonus_C::StaticClass()->DefaultObject);
