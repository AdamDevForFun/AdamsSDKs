...
class UClass* UDefaultSkillNode_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("DefaultSkillNode_C");

	return Clss;
}


// DefaultSkillNode_C DefaultSkillNode.Default__DefaultSkillNode_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UDefaultSkillNode_C* UDefaultSkillNode_C::GetDefaultObj()
{
	static class UDefaultSkillNode_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UDefaultSkillNode_C*>(UDefaultSkillNode_C::StaticClass()->DefaultObject);
...
// Parameters:
// class UMaterialInstanceDynamic*    CallFunc_GetSingleMaterialStyleMID_ReturnValue                   (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// struct FFortSkillTreeNodeDisplayDataCallFunc_TryGetNodeDisplayData_OutDisplayData                    (None)
// bool                               CallFunc_TryGetNodeDisplayData_ReturnValue                       (ZeroConstructor, IsPlainOldData, NoDestructor)
// struct FHomebaseNode               CallFunc_TryGetStaticSkillTreeNodeData_OutNodeData               (None)
