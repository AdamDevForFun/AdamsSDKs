...
class UClass* UStickyNotification_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("StickyNotification_C");

	return Clss;
}


// StickyNotification_C StickyNotification.Default__StickyNotification_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UStickyNotification_C* UStickyNotification_C::GetDefaultObj()
{
	static class UStickyNotification_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UStickyNotification_C*>(UStickyNotification_C::StaticClass()->DefaultObject);
