...
class UClass* UTopBarSkillPoints_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("TopBarSkillPoints_C");

	return Clss;
}


// TopBarSkillPoints_C TopBarSkillPoints.Default__TopBarSkillPoints_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UTopBarSkillPoints_C* UTopBarSkillPoints_C::GetDefaultObj()
{
	static class UTopBarSkillPoints_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UTopBarSkillPoints_C*>(UTopBarSkillPoints_C::StaticClass()->DefaultObject);
