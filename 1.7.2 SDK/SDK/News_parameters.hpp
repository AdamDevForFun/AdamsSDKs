...
public:
	...
	class FText                                  Temp_text_Variable5;                               // 0x68(0x18)(None)
	class FText                                  Temp_text_Variable6;                               // 0x80(0x18)(None)
	class FText                                  Temp_text_Variable7;                               // 0x98(0x18)(None)
	class FText                                  Temp_text_Variable8;                               // 0xB0(0x18)(None)
