...
public:
	...
	uint8                                        Pad_8[0x20];                                       // Fixing Size After Last (Predefined) Property  [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_10[0x1A0];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_11[0xB0];                                      // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_12[0x1A0];                                     // Fixing Size Of Struct [ Dumper-7 ]
