...
class UClass* USimpleSquadSlotButton_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("SimpleSquadSlotButton_C");

	return Clss;
}


// SimpleSquadSlotButton_C SimpleSquadSlotButton.Default__SimpleSquadSlotButton_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class USimpleSquadSlotButton_C* USimpleSquadSlotButton_C::GetDefaultObj()
{
	static class USimpleSquadSlotButton_C* Default = nullptr;

	if (!Default)
		Default = static_cast<USimpleSquadSlotButton_C*>(USimpleSquadSlotButton_C::StaticClass()->DefaultObject);
