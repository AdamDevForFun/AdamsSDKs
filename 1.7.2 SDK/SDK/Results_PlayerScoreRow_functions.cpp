...
class UClass* UResults_PlayerScoreRow_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("Results_PlayerScoreRow_C");

	return Clss;
}


// Results_PlayerScoreRow_C Results_PlayerScoreRow.Default__Results_PlayerScoreRow_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UResults_PlayerScoreRow_C* UResults_PlayerScoreRow_C::GetDefaultObj()
{
	static class UResults_PlayerScoreRow_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UResults_PlayerScoreRow_C*>(UResults_PlayerScoreRow_C::StaticClass()->DefaultObject);
