...
public:
	...
	uint8                                        Pad_2D29[0x7];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_2D33[0x1];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	struct FSlateBrush                           K2Node_MakeStruct_SlateBrush;                      // 0x18(0x90)(None)
	...
	uint8                                        Pad_2D35[0x5];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	struct FSlateBrush                           CallFunc_GetIcon_Brush;                            // 0xB0(0x90)(None)
	...
	struct FSlateBrush                           K2Node_Select2_Default;                            // 0x148(0x90)(None)
	struct FSlateBrush                           CallFunc_ResizeBrush_NewParam;                     // 0x1D8(0x90)(None)
};
...
public:
	struct FLinearColor                          CallFunc_GetHighlightColor_Color;                  // 0x0(0x10)(IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FSlateBrush                           CallFunc_NoResourceBrush_ReturnValue;              // 0x10(0x90)(None)
	...
	struct FSlateBrush                           CallFunc_GetIcon_Brush;                            // 0xA8(0x90)(None)
	...
	struct FSlateBrush                           K2Node_Select_Default;                             // 0x140(0x90)(None)
	struct FSlateBrush                           CallFunc_ResizeBrush_NewParam;                     // 0x1D0(0x90)(None)
};
