...
class UClass* UQuickbarPrimary_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("QuickbarPrimary_C");

	return Clss;
}


// QuickbarPrimary_C QuickbarPrimary.Default__QuickbarPrimary_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UQuickbarPrimary_C* UQuickbarPrimary_C::GetDefaultObj()
{
	static class UQuickbarPrimary_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UQuickbarPrimary_C*>(UQuickbarPrimary_C::StaticClass()->DefaultObject);
