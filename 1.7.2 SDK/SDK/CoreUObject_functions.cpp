...
class UClass* UAssetObjectProperty::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("AssetObjectProperty");

	return Clss;
}


// AssetObjectProperty CoreUObject.Default__AssetObjectProperty
// (Public, ClassDefaultObject, ArchetypeObject)

class UAssetObjectProperty* UAssetObjectProperty::GetDefaultObj()
{
	static class UAssetObjectProperty* Default = nullptr;

	if (!Default)
		Default = static_cast<UAssetObjectProperty*>(UAssetObjectProperty::StaticClass()->DefaultObject);
...
class UClass* UAssetClassProperty::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("AssetClassProperty");

	return Clss;
}


// AssetClassProperty CoreUObject.Default__AssetClassProperty
// (Public, ClassDefaultObject, ArchetypeObject)

class UAssetClassProperty* UAssetClassProperty::GetDefaultObj()
{
	static class UAssetClassProperty* Default = nullptr;

	if (!Default)
		Default = static_cast<UAssetClassProperty*>(UAssetClassProperty::StaticClass()->DefaultObject);
