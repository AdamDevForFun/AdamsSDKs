...
class UClass* UResults_BadgeLootBar_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("Results_BadgeLootBar_C");

	return Clss;
}


// Results_BadgeLootBar_C Results_BadgeLootBar.Default__Results_BadgeLootBar_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UResults_BadgeLootBar_C* UResults_BadgeLootBar_C::GetDefaultObj()
{
	static class UResults_BadgeLootBar_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UResults_BadgeLootBar_C*>(UResults_BadgeLootBar_C::StaticClass()->DefaultObject);
