...
class UClass* UAthenaInventoryDropSlot_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("AthenaInventoryDropSlot_C");

	return Clss;
}


// AthenaInventoryDropSlot_C AthenaInventoryDropSlot.Default__AthenaInventoryDropSlot_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UAthenaInventoryDropSlot_C* UAthenaInventoryDropSlot_C::GetDefaultObj()
{
	static class UAthenaInventoryDropSlot_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UAthenaInventoryDropSlot_C*>(UAthenaInventoryDropSlot_C::StaticClass()->DefaultObject);
