...
public:
	...
	uint8                                        Pad_3B4B[0x2];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	struct FFortMissionDetails                   CallFunc_GetTileMissionDetails_MissionDetails;     // 0x158(0x160)(None)
	...
	struct FFortMissionDetails                   CallFunc_GetTileMissionDetails_MissionDetails2;    // 0x2D8(0x160)(None)
	...
	class FText                                  CallFunc_Get_Conning_Color_From_Difficulty_Value_TooltipText; // 0x458(0x18)(None)
