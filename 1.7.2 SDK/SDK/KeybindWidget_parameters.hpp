...
public:
	...
	class FText                                  CallFunc_GetKeyTextForAction_ButtonActionType;     // 0x50(0x18)(None)
	class FText                                  CallFunc_GetKeyTextForAction_ReturnValue;          // 0x68(0x18)(None)
	...
	struct FSlateBrush                           CallFunc_GetBrushForKey_Brush;                     // 0x1A8(0x90)(None)
	...
	class FText                                  CallFunc_GetText_ReturnValue;                      // 0x240(0x18)(None)
