...
public:
	...
	class FText                                  K2Node_Select2_Default;                            // 0x70(0x18)(None)
};
...
public:
	...
	struct FFortAnalyticsEventAttribute          CallFunc_ConstructAnalyticsAttribute_ReturnValue;  // 0x60(0x20)(None)
};
...
public:
	...
	struct FFortAnalyticsEventAttribute          CallFunc_ConstructAnalyticsAttribute_ReturnValue;  // 0x68(0x20)(None)
};
...
public:
	...
	uint8                                        Pad_35BF[0x5];                                     // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	...
	class FText                                  K2Node_ComponentBoundEvent_NewTooltipText;         // 0x8(0x18)(None)
