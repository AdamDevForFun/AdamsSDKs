...
class UClass* UInteractionIndicator_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("InteractionIndicator_C");

	return Clss;
}


// InteractionIndicator_C InteractionIndicator.Default__InteractionIndicator_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UInteractionIndicator_C* UInteractionIndicator_C::GetDefaultObj()
{
	static class UInteractionIndicator_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UInteractionIndicator_C*>(UInteractionIndicator_C::StaticClass()->DefaultObject);
