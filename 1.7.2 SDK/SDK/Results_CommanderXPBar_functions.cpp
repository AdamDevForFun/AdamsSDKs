...
class UClass* UResults_CommanderXPBar_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("Results_CommanderXPBar_C");

	return Clss;
}


// Results_CommanderXPBar_C Results_CommanderXPBar.Default__Results_CommanderXPBar_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UResults_CommanderXPBar_C* UResults_CommanderXPBar_C::GetDefaultObj()
{
	static class UResults_CommanderXPBar_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UResults_CommanderXPBar_C*>(UResults_CommanderXPBar_C::StaticClass()->DefaultObject);
...
// TScriptInterface<class IFortClientAnnouncement_ConversationCodeInterface>K2Node_DynamicCast_AsFort_Client_Announcement_Conversation_Code_Interface2(ZeroConstructor, IsPlainOldData, NoDestructor)
// bool                               K2Node_DynamicCast_bSuccess2                                     (ZeroConstructor, IsPlainOldData, NoDestructor)
// TScriptInterface<class IFortClientAnnouncement_ConversationCodeInterface>K2Node_DynamicCast_AsFort_Client_Announcement_Conversation_Code_Interface3(ZeroConstructor, IsPlainOldData, NoDestructor)
// bool                               K2Node_DynamicCast_bSuccess3                                     (ZeroConstructor, IsPlainOldData, NoDestructor)

void UResults_CommanderXPBar_C::UpdateXpType(int32 XPAmount, class FName XPType, bool bEarnedXP, bool K2Node_SwitchName_CmpSuccess, const struct FResults_CommanderXP_Data& CallFunc_Array_Get_Item, TScriptInterface<class IFortClientAnnouncement_ConversationCodeInterface> K2Node_DynamicCast_AsFort_Client_Announcement_Conversation_Code_Interface, bool K2Node_DynamicCast_bSuccess, bool CallFunc_Greater_IntInt_ReturnValue, TScriptInterface<class IFortClientAnnouncement_ConversationCodeInterface> K2Node_DynamicCast_AsFort_Client_Announcement_Conversation_Code_Interface2, bool K2Node_DynamicCast_bSuccess2, TScriptInterface<class IFortClientAnnouncement_ConversationCodeInterface> K2Node_DynamicCast_AsFort_Client_Announcement_Conversation_Code_Interface3, bool K2Node_DynamicCast_bSuccess3)
{
	static class UFunction* Func = nullptr;
