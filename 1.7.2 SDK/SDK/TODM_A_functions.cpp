...
class UClass* ATODM_A_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("TODM_A_C");

	return Clss;
}


// TODM_A_C TODM_A.Default__TODM_A_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class ATODM_A_C* ATODM_A_C::GetDefaultObj()
{
	static class ATODM_A_C* Default = nullptr;

	if (!Default)
		Default = static_cast<ATODM_A_C*>(ATODM_A_C::StaticClass()->DefaultObject);
