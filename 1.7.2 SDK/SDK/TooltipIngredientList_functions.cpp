...
class UClass* UTooltipIngredientList_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("TooltipIngredientList_C");

	return Clss;
}


// TooltipIngredientList_C TooltipIngredientList.Default__TooltipIngredientList_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UTooltipIngredientList_C* UTooltipIngredientList_C::GetDefaultObj()
{
	static class UTooltipIngredientList_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UTooltipIngredientList_C*>(UTooltipIngredientList_C::StaticClass()->DefaultObject);
