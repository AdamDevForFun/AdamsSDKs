...
class UClass* UBadgesEarnedPanelContent_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("BadgesEarnedPanelContent_C");

	return Clss;
}


// BadgesEarnedPanelContent_C BadgesEarnedPanelContent.Default__BadgesEarnedPanelContent_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UBadgesEarnedPanelContent_C* UBadgesEarnedPanelContent_C::GetDefaultObj()
{
	static class UBadgesEarnedPanelContent_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UBadgesEarnedPanelContent_C*>(UBadgesEarnedPanelContent_C::StaticClass()->DefaultObject);
...
// struct FEarnedBadgePlayerData      CallFunc_Array_Get_Item                                          (None)
...
// int32                              Temp_int_Array_Index_Variable                                    (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// int32                              CallFunc_Array_Length_ReturnValue                                (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// struct FEarnedBadgeEntry           CallFunc_Array_Get_Item                                          (None)
