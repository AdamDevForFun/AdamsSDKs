...
class UClass* UMgmtTabsScreen_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("MgmtTabsScreen_C");

	return Clss;
}


// MgmtTabsScreen_C MgmtTabsScreen.Default__MgmtTabsScreen_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UMgmtTabsScreen_C* UMgmtTabsScreen_C::GetDefaultObj()
{
	static class UMgmtTabsScreen_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UMgmtTabsScreen_C*>(UMgmtTabsScreen_C::StaticClass()->DefaultObject);
