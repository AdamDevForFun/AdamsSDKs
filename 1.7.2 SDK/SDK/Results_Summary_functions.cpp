...
class UClass* UResults_Summary_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("Results_Summary_C");

	return Clss;
}


// Results_Summary_C Results_Summary.Default__Results_Summary_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UResults_Summary_C* UResults_Summary_C::GetDefaultObj()
{
	static class UResults_Summary_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UResults_Summary_C*>(UResults_Summary_C::StaticClass()->DefaultObject);
