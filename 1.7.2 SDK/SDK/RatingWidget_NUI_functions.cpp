...
class UClass* URatingWidget_NUI_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("RatingWidget_NUI_C");

	return Clss;
}


// RatingWidget_NUI_C RatingWidget_NUI.Default__RatingWidget_NUI_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class URatingWidget_NUI_C* URatingWidget_NUI_C::GetDefaultObj()
{
	static class URatingWidget_NUI_C* Default = nullptr;

	if (!Default)
		Default = static_cast<URatingWidget_NUI_C*>(URatingWidget_NUI_C::StaticClass()->DefaultObject);
