...
class UClass* UPrivacyWidget_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("PrivacyWidget_C");

	return Clss;
}


// PrivacyWidget_C PrivacyWidget.Default__PrivacyWidget_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UPrivacyWidget_C* UPrivacyWidget_C::GetDefaultObj()
{
	static class UPrivacyWidget_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UPrivacyWidget_C*>(UPrivacyWidget_C::StaticClass()->DefaultObject);
