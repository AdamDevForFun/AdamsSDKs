...
public:
	...
	struct FSlateBrush                           CallFunc_GetItemDefinitionSmallPreviewImageBrush_ReturnValue; // 0x8(0x90)(None)
	class FText                                  CallFunc_GetDisplayName_ReturnValue;               // 0x98(0x18)(None)
	struct FSlateBrush                           CallFunc_ResizeBrush_NewParam;                     // 0xB0(0x90)(None)
	class FText                                  CallFunc_GetSingleLineDescription_ReturnValue;     // 0x140(0x18)(None)
...
public:
	...
	struct FSlateBrush                           CallFunc_GetItemDefinitionSmallPreviewImageBrush_ReturnValue; // 0xE8(0x90)(None)
