...
struct UMissionRewardItemMinusTooltip_C_Get_Rarity_Color__SlateColor__Params
{
public:
...
struct UMissionRewardItemMinusTooltip_C_Get_Rarity_Color_Params
{
public:
...
struct UMissionRewardItemMinusTooltip_C_Get_Reward_Icon_Params
{
public:
	...
	struct FSlateBrush                           CallFunc_GetItemSmallPreviewImageBrush_ReturnValue; // 0x128(0x90)(None)
};

// 0x70 (0x70 - 0x0)
// Function MissionRewardItem-Tooltip.MissionRewardItem-Tooltip_C.Get Reward Name
struct UMissionRewardItemMinusTooltip_C_Get_Reward_Name_Params
{
public:
