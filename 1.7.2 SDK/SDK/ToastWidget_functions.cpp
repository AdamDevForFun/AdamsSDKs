...
class UClass* UToastWidget_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("ToastWidget_C");

	return Clss;
}


// ToastWidget_C ToastWidget.Default__ToastWidget_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UToastWidget_C* UToastWidget_C::GetDefaultObj()
{
	static class UToastWidget_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UToastWidget_C*>(UToastWidget_C::StaticClass()->DefaultObject);
