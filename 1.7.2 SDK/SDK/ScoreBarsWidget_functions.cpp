...
class UClass* UScoreBarsWidget_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("ScoreBarsWidget_C");

	return Clss;
}


// ScoreBarsWidget_C ScoreBarsWidget.Default__ScoreBarsWidget_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UScoreBarsWidget_C* UScoreBarsWidget_C::GetDefaultObj()
{
	static class UScoreBarsWidget_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UScoreBarsWidget_C*>(UScoreBarsWidget_C::StaticClass()->DefaultObject);
...
// bool                               K2Node_DynamicCast_bSuccess                                      (ZeroConstructor, IsPlainOldData, NoDestructor)
// TScriptInterface<class IScoreBadgeProviderMission_C>K2Node_DynamicCast_AsScore_Badge_Provider_Mission2               (ZeroConstructor, IsPlainOldData, NoDestructor)
...
// TScriptInterface<class IScoreBadgeProviderMission_C>K2Node_DynamicCast_AsScore_Badge_Provider_Mission3               (ZeroConstructor, IsPlainOldData, NoDestructor)
// bool                               K2Node_DynamicCast_bSuccess3                                     (ZeroConstructor, IsPlainOldData, NoDestructor)
// int32                              CallFunc_GetTotalScore_Score3                                    (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void UScoreBarsWidget_C::UpdateScoreTotals(int32 OldUtilityScore, int32 OldBuildingScore, int32 OldCombatScore, TScriptInterface<class IScoreBadgeProviderMission_C> K2Node_DynamicCast_AsScore_Badge_Provider_Mission, bool K2Node_DynamicCast_bSuccess, TScriptInterface<class IScoreBadgeProviderMission_C> K2Node_DynamicCast_AsScore_Badge_Provider_Mission2, bool K2Node_DynamicCast_bSuccess2, int32 CallFunc_GetTotalScore_Score, int32 CallFunc_GetTotalScore_Score2, TScriptInterface<class IScoreBadgeProviderMission_C> K2Node_DynamicCast_AsScore_Badge_Provider_Mission3, bool K2Node_DynamicCast_bSuccess3, int32 CallFunc_GetTotalScore_Score3)
{
	static class UFunction* Func = nullptr;
