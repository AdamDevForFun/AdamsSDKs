...
public:
	...
	class FText                                  CallFunc_GetText_ReturnValue2;                     // 0x38(0x18)(None)
...
public:
	...
	class FText                                  CallFunc_GetText_ReturnValue;                      // 0x48(0x18)(None)
	...
	class FText                                  CallFunc_GetCurrentFocusDisplayText_ReturnValue;   // 0x68(0x18)(None)
	...
	class FText                                  CallFunc_GetTimeText_ReturnValue;                  // 0xC0(0x18)(None)
};
