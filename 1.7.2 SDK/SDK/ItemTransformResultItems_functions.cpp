...
class UClass* UItemTransformResultItems_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("ItemTransformResultItems_C");

	return Clss;
}


// ItemTransformResultItems_C ItemTransformResultItems.Default__ItemTransformResultItems_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UItemTransformResultItems_C* UItemTransformResultItems_C::GetDefaultObj()
{
	static class UItemTransformResultItems_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UItemTransformResultItems_C*>(UItemTransformResultItems_C::StaticClass()->DefaultObject);
...
// class FText                        CallFunc_GetRewardName_ReturnValue                               (None)
