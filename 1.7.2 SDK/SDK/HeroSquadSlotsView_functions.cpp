...
class UClass* UHeroSquadSlotsView_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("HeroSquadSlotsView_C");

	return Clss;
}


// HeroSquadSlotsView_C HeroSquadSlotsView.Default__HeroSquadSlotsView_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UHeroSquadSlotsView_C* UHeroSquadSlotsView_C::GetDefaultObj()
{
	static class UHeroSquadSlotsView_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UHeroSquadSlotsView_C*>(UHeroSquadSlotsView_C::StaticClass()->DefaultObject);
