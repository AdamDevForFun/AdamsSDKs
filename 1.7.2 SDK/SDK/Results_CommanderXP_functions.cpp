...
class UClass* UResults_CommanderXP_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("Results_CommanderXP_C");

	return Clss;
}


// Results_CommanderXP_C Results_CommanderXP.Default__Results_CommanderXP_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UResults_CommanderXP_C* UResults_CommanderXP_C::GetDefaultObj()
{
	static class UResults_CommanderXP_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UResults_CommanderXP_C*>(UResults_CommanderXP_C::StaticClass()->DefaultObject);
...
// int32                              CallFunc_Add_IntInt_ReturnValue                                  (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// struct FFortHomeBaseInfo           CallFunc_GetHomeBaseInfo_Result2                                 (None)
