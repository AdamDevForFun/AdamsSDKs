...
class UTooltipMinusItem_C : public UUserWidget
{
public:
	...
	class UImage*                                _Image__DivMinusHeader;                            // 0x250(0x8)(ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
