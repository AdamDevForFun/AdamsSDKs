...
class UClass* UXpBarXpText_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("XpBarXpText_C");

	return Clss;
}


// XpBarXpText_C XpBarXpText.Default__XpBarXpText_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UXpBarXpText_C* UXpBarXpText_C::GetDefaultObj()
{
	static class UXpBarXpText_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UXpBarXpText_C*>(UXpBarXpText_C::StaticClass()->DefaultObject);
