...
class UClass* AB_Pickups_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("B_Pickups_C");

	return Clss;
}


// B_Pickups_C B_Pickups.Default__B_Pickups_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class AB_Pickups_C* AB_Pickups_C::GetDefaultObj()
{
	static class AB_Pickups_C* Default = nullptr;

	if (!Default)
		Default = static_cast<AB_Pickups_C*>(AB_Pickups_C::StaticClass()->DefaultObject);
