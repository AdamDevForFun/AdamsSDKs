...
class UClass* UAthenaViewTargetHitPointBar_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("AthenaViewTargetHitPointBar_C");

	return Clss;
}


// AthenaViewTargetHitPointBar_C AthenaViewTargetHitPointBar.Default__AthenaViewTargetHitPointBar_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UAthenaViewTargetHitPointBar_C* UAthenaViewTargetHitPointBar_C::GetDefaultObj()
{
	static class UAthenaViewTargetHitPointBar_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UAthenaViewTargetHitPointBar_C*>(UAthenaViewTargetHitPointBar_C::StaticClass()->DefaultObject);
