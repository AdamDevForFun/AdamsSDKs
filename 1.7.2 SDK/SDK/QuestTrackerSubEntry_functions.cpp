...
class UClass* UQuestTrackerSubEntry_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("QuestTrackerSubEntry_C");

	return Clss;
}


// QuestTrackerSubEntry_C QuestTrackerSubEntry.Default__QuestTrackerSubEntry_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UQuestTrackerSubEntry_C* UQuestTrackerSubEntry_C::GetDefaultObj()
{
	static class UQuestTrackerSubEntry_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UQuestTrackerSubEntry_C*>(UQuestTrackerSubEntry_C::StaticClass()->DefaultObject);
