...
class UClass* UPlayerChoiceWidget_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("PlayerChoiceWidget_C");

	return Clss;
}


// PlayerChoiceWidget_C PlayerChoiceWidget.Default__PlayerChoiceWidget_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UPlayerChoiceWidget_C* UPlayerChoiceWidget_C::GetDefaultObj()
{
	static class UPlayerChoiceWidget_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UPlayerChoiceWidget_C*>(UPlayerChoiceWidget_C::StaticClass()->DefaultObject);
...
// struct FChoiceDataEntry            CallFunc_Array_Get_Item                                          (None)
