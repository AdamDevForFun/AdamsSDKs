...
class UClass* UQuestProgressWidget_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("QuestProgressWidget_C");

	return Clss;
}


// QuestProgressWidget_C QuestProgressWidget.Default__QuestProgressWidget_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UQuestProgressWidget_C* UQuestProgressWidget_C::GetDefaultObj()
{
	static class UQuestProgressWidget_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UQuestProgressWidget_C*>(UQuestProgressWidget_C::StaticClass()->DefaultObject);
