...
class UClass* UItemManagementMulchModeBox_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("ItemManagementMulchModeBox_C");

	return Clss;
}


// ItemManagementMulchModeBox_C ItemManagementMulchModeBox.Default__ItemManagementMulchModeBox_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UItemManagementMulchModeBox_C* UItemManagementMulchModeBox_C::GetDefaultObj()
{
	static class UItemManagementMulchModeBox_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UItemManagementMulchModeBox_C*>(UItemManagementMulchModeBox_C::StaticClass()->DefaultObject);
