...
class UClass* UPinnedSchematicItemsWidget_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("PinnedSchematicItemsWidget_C");

	return Clss;
}


// PinnedSchematicItemsWidget_C PinnedSchematicItemsWidget.Default__PinnedSchematicItemsWidget_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UPinnedSchematicItemsWidget_C* UPinnedSchematicItemsWidget_C::GetDefaultObj()
{
	static class UPinnedSchematicItemsWidget_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UPinnedSchematicItemsWidget_C*>(UPinnedSchematicItemsWidget_C::StaticClass()->DefaultObject);
