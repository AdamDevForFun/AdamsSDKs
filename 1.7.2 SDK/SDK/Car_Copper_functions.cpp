...
class UClass* ACar_Copper_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("Car_Copper_C");

	return Clss;
}


// Car_Copper_C Car_Copper.Default__Car_Copper_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class ACar_Copper_C* ACar_Copper_C::GetDefaultObj()
{
	static class ACar_Copper_C* Default = nullptr;

	if (!Default)
		Default = static_cast<ACar_Copper_C*>(ACar_Copper_C::StaticClass()->DefaultObject);
