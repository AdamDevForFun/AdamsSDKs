...
class UClass* UXpBoostQuantities_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("XpBoostQuantities_C");

	return Clss;
}


// XpBoostQuantities_C XpBoostQuantities.Default__XpBoostQuantities_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UXpBoostQuantities_C* UXpBoostQuantities_C::GetDefaultObj()
{
	static class UXpBoostQuantities_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UXpBoostQuantities_C*>(UXpBoostQuantities_C::StaticClass()->DefaultObject);
