...
class UClass* UAccountBonuses_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("AccountBonuses_C");

	return Clss;
}


// AccountBonuses_C AccountBonuses.Default__AccountBonuses_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UAccountBonuses_C* UAccountBonuses_C::GetDefaultObj()
{
	static class UAccountBonuses_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UAccountBonuses_C*>(UAccountBonuses_C::StaticClass()->DefaultObject);
...
// class FText                        CallFunc_GetCombinedDescription_OutDescription2                  (None)
