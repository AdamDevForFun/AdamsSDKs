...
class UClass* UInteraction_DefenderBeacon_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("Interaction_DefenderBeacon_C");

	return Clss;
}


// Interaction_DefenderBeacon_C Interaction_DefenderBeacon.Default__Interaction_DefenderBeacon_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UInteraction_DefenderBeacon_C* UInteraction_DefenderBeacon_C::GetDefaultObj()
{
	static class UInteraction_DefenderBeacon_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UInteraction_DefenderBeacon_C*>(UInteraction_DefenderBeacon_C::StaticClass()->DefaultObject);
...
// class FText                        CallFunc_GetLastInteractErrorText_ReturnValue                    (None)
