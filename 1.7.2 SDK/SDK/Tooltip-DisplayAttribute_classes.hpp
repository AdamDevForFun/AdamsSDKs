...
class UTooltipMinusDisplayAttribute_C : public UFortAttributeListItem
{
public:
	...
	uint8                                        Pad_2C71[0x1];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	void PreviewStarted();
	void PreviewEnded();
	void ExecuteUbergraph_TooltipMinusDisplayAttribute(int32 EntryPoint, const struct FFortDisplayAttribute& CallFunc_SetDisplayAttribute_DeltaAttribute, bool CallFunc_SetDisplayAttribute_ReturnValue, float K2Node_Event_Delta, class UWidget* CallFunc_GetToolTipWidget_ReturnValue);
};
