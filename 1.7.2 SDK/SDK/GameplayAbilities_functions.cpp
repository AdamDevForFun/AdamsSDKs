...
class UClass* UGameplayEffectExtension::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("GameplayEffectExtension");

	return Clss;
}


// GameplayEffectExtension GameplayAbilities.Default__GameplayEffectExtension
// (Public, ClassDefaultObject, ArchetypeObject)

class UGameplayEffectExtension* UGameplayEffectExtension::GetDefaultObj()
{
	static class UGameplayEffectExtension* Default = nullptr;

	if (!Default)
		Default = static_cast<UGameplayEffectExtension*>(UGameplayEffectExtension::StaticClass()->DefaultObject);
...
class UClass* UGameplayEffectExtension_LifestealTest::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("GameplayEffectExtension_LifestealTest");

	return Clss;
}


// GameplayEffectExtension_LifestealTest GameplayAbilities.Default__GameplayEffectExtension_LifestealTest
// (Public, ClassDefaultObject, ArchetypeObject)

class UGameplayEffectExtension_LifestealTest* UGameplayEffectExtension_LifestealTest::GetDefaultObj()
{
	static class UGameplayEffectExtension_LifestealTest* Default = nullptr;

	if (!Default)
		Default = static_cast<UGameplayEffectExtension_LifestealTest*>(UGameplayEffectExtension_LifestealTest::StaticClass()->DefaultObject);
...
class UClass* UGameplayEffectExtension_ShieldTest::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("GameplayEffectExtension_ShieldTest");

	return Clss;
}


// GameplayEffectExtension_ShieldTest GameplayAbilities.Default__GameplayEffectExtension_ShieldTest
// (Public, ClassDefaultObject, ArchetypeObject)

class UGameplayEffectExtension_ShieldTest* UGameplayEffectExtension_ShieldTest::GetDefaultObj()
{
	static class UGameplayEffectExtension_ShieldTest* Default = nullptr;

	if (!Default)
		Default = static_cast<UGameplayEffectExtension_ShieldTest*>(UGameplayEffectExtension_ShieldTest::StaticClass()->DefaultObject);
