...
class UClass* UTeamScoreToPlayerXPRewardWidget_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("TeamScoreToPlayerXPRewardWidget_C");

	return Clss;
}


// TeamScoreToPlayerXPRewardWidget_C TeamScoreToPlayerXPRewardWidget.Default__TeamScoreToPlayerXPRewardWidget_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UTeamScoreToPlayerXPRewardWidget_C* UTeamScoreToPlayerXPRewardWidget_C::GetDefaultObj()
{
	static class UTeamScoreToPlayerXPRewardWidget_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UTeamScoreToPlayerXPRewardWidget_C*>(UTeamScoreToPlayerXPRewardWidget_C::StaticClass()->DefaultObject);
