...
{
public:
	struct FFortTeamMemberInfo                   Temp_struct_Variable;                              // 0x0(0x190)(None)
	...
	struct FFortTeamMemberInfo                   CallFunc_Array_Get_Item;                           // 0x1B8(0x190)(None)
	...
	struct FFortTeamMemberInfo                   K2Node_Select_Default;                             // 0x360(0x190)(None)
};
