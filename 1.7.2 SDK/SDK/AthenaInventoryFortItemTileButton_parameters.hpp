...
public:
	...
	struct FEventReply                           CallFunc_Unhandled_ReturnValue2;                   // 0x2E8(0xB8)(None)
};
...
public:
	...
	uint8                                        Pad_275D[0x5];                                     // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	...
	struct FInputEvent                           CallFunc_GetInputEventFromPointerEvent_ReturnValue; // 0xC0(0x20)(None)
