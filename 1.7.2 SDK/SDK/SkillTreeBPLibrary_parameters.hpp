...
public:
	...
	uint8                                        Pad_2A18[0x1];                                     // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	...
	struct FSlateColor                           CallFunc_GetQuestNodeColour_ReturnValue;           // 0xE8(0x28)(None)
	...
	struct FFortItemQuantityPair                 CallFunc_Array_Get_Item;                           // 0x118(0x28)(None)
