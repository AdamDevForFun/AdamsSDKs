...
public:
	...
	class FText                                  CallFunc_GetDisplayNameAndMultiBrushForTag_OutDisplayName; // 0x298(0x18)(None)
	struct FFortMultiSizeBrush                   CallFunc_GetDisplayNameAndMultiBrushForTag_OutBrush; // 0x2B0(0x360)(None)
...
public:
	...
	struct FSlateBrush                           CallFunc_Get_Bonus_Display_Name_and_Brush_OutBrush_Brush_M; // 0x48(0x90)(None)
	class FText                                  CallFunc_Get_Bonus_Display_Name_and_Brush_OutDisplayName; // 0xD8(0x18)(None)
...
public:
	...
	struct FFortTagUIData                        CallFunc_GetUIDataForTag_OutData;                  // 0x58(0x398)(None)
...
public:
	...
	struct FConfirmationDialogAction             K2Node_MakeStruct_ConfirmationDialogAction;        // 0xA8(0xD0)(None)
