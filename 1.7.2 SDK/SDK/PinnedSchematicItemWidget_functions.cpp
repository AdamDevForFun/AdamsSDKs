...
class UClass* UPinnedSchematicItemWidget_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("PinnedSchematicItemWidget_C");

	return Clss;
}


// PinnedSchematicItemWidget_C PinnedSchematicItemWidget.Default__PinnedSchematicItemWidget_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UPinnedSchematicItemWidget_C* UPinnedSchematicItemWidget_C::GetDefaultObj()
{
	static class UPinnedSchematicItemWidget_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UPinnedSchematicItemWidget_C*>(UPinnedSchematicItemWidget_C::StaticClass()->DefaultObject);
