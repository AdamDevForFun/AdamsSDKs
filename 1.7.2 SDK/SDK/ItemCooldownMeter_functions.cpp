...
class UClass* UItemCooldownMeter_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("ItemCooldownMeter_C");

	return Clss;
}


// ItemCooldownMeter_C ItemCooldownMeter.Default__ItemCooldownMeter_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UItemCooldownMeter_C* UItemCooldownMeter_C::GetDefaultObj()
{
	static class UItemCooldownMeter_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UItemCooldownMeter_C*>(UItemCooldownMeter_C::StaticClass()->DefaultObject);
