...
class UClass* UCraftingIngredient_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("CraftingIngredient_C");

	return Clss;
}


// CraftingIngredient_C CraftingIngredient.Default__CraftingIngredient_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UCraftingIngredient_C* UCraftingIngredient_C::GetDefaultObj()
{
	static class UCraftingIngredient_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UCraftingIngredient_C*>(UCraftingIngredient_C::StaticClass()->DefaultObject);
