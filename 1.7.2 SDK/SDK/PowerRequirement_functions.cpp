...
class UClass* UPowerRequirement_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("PowerRequirement_C");

	return Clss;
}


// PowerRequirement_C PowerRequirement.Default__PowerRequirement_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UPowerRequirement_C* UPowerRequirement_C::GetDefaultObj()
{
	static class UPowerRequirement_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UPowerRequirement_C*>(UPowerRequirement_C::StaticClass()->DefaultObject);
