...
class UClass* UPickupManager_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("PickupManager_C");

	return Clss;
}


// PickupManager_C PickupManager.Default__PickupManager_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UPickupManager_C* UPickupManager_C::GetDefaultObj()
{
	static class UPickupManager_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UPickupManager_C*>(UPickupManager_C::StaticClass()->DefaultObject);
