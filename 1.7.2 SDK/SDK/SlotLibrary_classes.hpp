...
public:
	...
	void EnsureIconBrush(const struct FFortMultiSizeBrush& MultiMinussize_Brush, class UObject* __WorldContext, struct FSlateBrush* Brush, bool Temp_bool_Variable, const struct FSlateBrush& K2Node_MakeStruct_SlateBrush, bool CallFunc_IsValid_ReturnValue, const struct FSlateBrush& K2Node_Select_Default);
