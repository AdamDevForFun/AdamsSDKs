...
class UClass* UAthenaKillerPortraitWidget_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("AthenaKillerPortraitWidget_C");

	return Clss;
}


// AthenaKillerPortraitWidget_C AthenaKillerPortraitWidget.Default__AthenaKillerPortraitWidget_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UAthenaKillerPortraitWidget_C* UAthenaKillerPortraitWidget_C::GetDefaultObj()
{
	static class UAthenaKillerPortraitWidget_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UAthenaKillerPortraitWidget_C*>(UAthenaKillerPortraitWidget_C::StaticClass()->DefaultObject);
