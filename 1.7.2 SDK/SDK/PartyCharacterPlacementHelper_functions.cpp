...
class UClass* APartyCharacterPlacementHelper_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("PartyCharacterPlacementHelper_C");

	return Clss;
}


// PartyCharacterPlacementHelper_C PartyCharacterPlacementHelper.Default__PartyCharacterPlacementHelper_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class APartyCharacterPlacementHelper_C* APartyCharacterPlacementHelper_C::GetDefaultObj()
{
	static class APartyCharacterPlacementHelper_C* Default = nullptr;

	if (!Default)
		Default = static_cast<APartyCharacterPlacementHelper_C*>(APartyCharacterPlacementHelper_C::StaticClass()->DefaultObject);
