...
class UClass* UXpBoostInfoText_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("XpBoostInfoText_C");

	return Clss;
}


// XpBoostInfoText_C XpBoostInfoText.Default__XpBoostInfoText_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UXpBoostInfoText_C* UXpBoostInfoText_C::GetDefaultObj()
{
	static class UXpBoostInfoText_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UXpBoostInfoText_C*>(UXpBoostInfoText_C::StaticClass()->DefaultObject);
