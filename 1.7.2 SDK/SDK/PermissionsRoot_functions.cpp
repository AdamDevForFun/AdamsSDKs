...
class UClass* UPermissionsRoot_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("PermissionsRoot_C");

	return Clss;
}


// PermissionsRoot_C PermissionsRoot.Default__PermissionsRoot_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UPermissionsRoot_C* UPermissionsRoot_C::GetDefaultObj()
{
	static class UPermissionsRoot_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UPermissionsRoot_C*>(UPermissionsRoot_C::StaticClass()->DefaultObject);
...
// class FText                        CallFunc_GetCurrentTheaterName_ReturnValue                       (None)
...
// struct FFortTeamMemberInfo         CallFunc_GetLocalPlayerTeamMemberInfo_LocalPlayerInfo2           (None)
