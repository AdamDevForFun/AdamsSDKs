...
class UClass* UHUD_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("HUD_C");

	return Clss;
}


// HUD_C HUD.Default__HUD_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UHUD_C* UHUD_C::GetDefaultObj()
{
	static class UHUD_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UHUD_C*>(UHUD_C::StaticClass()->DefaultObject);
