...
public:
	...
	bool                                         ShowMinusDescriptions;                             // 0x18(0x1)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor)
	...
	struct FSlateBrush                           CallFunc_GetSmallPreviewImageBrush_ReturnValue;    // 0x78(0x90)(None)
	class FText                                  CallFunc_GetShortDescription_ReturnValue;          // 0x108(0x18)(None)
	...
	class FText                                  CallFunc_GetDisplayName_ReturnValue;               // 0x128(0x18)(None)
