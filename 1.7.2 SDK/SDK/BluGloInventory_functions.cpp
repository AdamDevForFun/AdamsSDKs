...
class UClass* UBluGloInventory_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("BluGloInventory_C");

	return Clss;
}


// BluGloInventory_C BluGloInventory.Default__BluGloInventory_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UBluGloInventory_C* UBluGloInventory_C::GetDefaultObj()
{
	static class UBluGloInventory_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UBluGloInventory_C*>(UBluGloInventory_C::StaticClass()->DefaultObject);
