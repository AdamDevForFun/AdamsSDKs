...
class UClass* UHelpWidget_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("HelpWidget_C");

	return Clss;
}


// HelpWidget_C HelpWidget.Default__HelpWidget_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UHelpWidget_C* UHelpWidget_C::GetDefaultObj()
{
	static class UHelpWidget_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UHelpWidget_C*>(UHelpWidget_C::StaticClass()->DefaultObject);
