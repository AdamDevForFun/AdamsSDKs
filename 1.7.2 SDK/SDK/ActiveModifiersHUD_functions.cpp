...
class UClass* UActiveModifiersHUD_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("ActiveModifiersHUD_C");

	return Clss;
}


// ActiveModifiersHUD_C ActiveModifiersHUD.Default__ActiveModifiersHUD_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UActiveModifiersHUD_C* UActiveModifiersHUD_C::GetDefaultObj()
{
	static class UActiveModifiersHUD_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UActiveModifiersHUD_C*>(UActiveModifiersHUD_C::StaticClass()->DefaultObject);
