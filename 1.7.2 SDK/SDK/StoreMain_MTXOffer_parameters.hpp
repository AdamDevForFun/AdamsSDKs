...
public:
	...
	uint8                                        Pad_351E[0x1];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_351F[0x2];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	struct FSlateBrush                           CallFunc_GetTileImage_ReturnValue;                 // 0xB8(0x90)(None)
	...
	class FText                                  CallFunc_GetNormalPrice_ReturnValue;               // 0x188(0x18)(None)
	class FText                                  CallFunc_Conv_IntToText_ReturnValue2;              // 0x1A0(0x18)(None)
	class FText                                  CallFunc_GetNormalPrice_ReturnValue2;              // 0x1B8(0x18)(None)
	class FText                                  CallFunc_GetSalePrice_SalePrice;                   // 0x1D0(0x18)(None)
	...
	class FText                                  K2Node_Select2_Default;                            // 0x1F0(0x18)(None)
};
