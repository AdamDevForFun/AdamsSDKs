...
class UClass* URewardsListWidget_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("RewardsListWidget_C");

	return Clss;
}


// RewardsListWidget_C RewardsListWidget.Default__RewardsListWidget_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class URewardsListWidget_C* URewardsListWidget_C::GetDefaultObj()
{
	static class URewardsListWidget_C* Default = nullptr;

	if (!Default)
		Default = static_cast<URewardsListWidget_C*>(URewardsListWidget_C::StaticClass()->DefaultObject);
