...
class UClass* UHordeWaveAlertWidget_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("HordeWaveAlertWidget_C");

	return Clss;
}


// HordeWaveAlertWidget_C HordeWaveAlertWidget.Default__HordeWaveAlertWidget_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UHordeWaveAlertWidget_C* UHordeWaveAlertWidget_C::GetDefaultObj()
{
	static class UHordeWaveAlertWidget_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UHordeWaveAlertWidget_C*>(UHordeWaveAlertWidget_C::StaticClass()->DefaultObject);
