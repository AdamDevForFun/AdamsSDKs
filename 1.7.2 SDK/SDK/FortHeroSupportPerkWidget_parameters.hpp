...
public:
	...
	uint8                                        Pad_2567[0x5];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	struct FSlateColor                           K2Node_MakeStruct_SlateColor2;                     // 0x88(0x28)(None)
	...
	struct FSlateBrush                           K2Node_MakeStruct_SlateBrush;                      // 0xB8(0x90)(None)
	...
	struct FSlateBrush                           K2Node_MakeStruct_SlateBrush2;                     // 0x150(0x90)(None)
