...
class UClass* UItemTransformResultInfo_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("ItemTransformResultInfo_C");

	return Clss;
}


// ItemTransformResultInfo_C ItemTransformResultInfo.Default__ItemTransformResultInfo_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UItemTransformResultInfo_C* UItemTransformResultInfo_C::GetDefaultObj()
{
	static class UItemTransformResultInfo_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UItemTransformResultInfo_C*>(UItemTransformResultInfo_C::StaticClass()->DefaultObject);
