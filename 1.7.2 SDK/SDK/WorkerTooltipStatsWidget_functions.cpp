...
class UClass* UWorkerTooltipStatsWidget_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("WorkerTooltipStatsWidget_C");

	return Clss;
}


// WorkerTooltipStatsWidget_C WorkerTooltipStatsWidget.Default__WorkerTooltipStatsWidget_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UWorkerTooltipStatsWidget_C* UWorkerTooltipStatsWidget_C::GetDefaultObj()
{
	static class UWorkerTooltipStatsWidget_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UWorkerTooltipStatsWidget_C*>(UWorkerTooltipStatsWidget_C::StaticClass()->DefaultObject);
