...
public:
	...
	TScriptInterface<class ICustomCharacterPartOwnerInterface> K2Node_DynamicCast_AsCustom_Character_Part_Owner_Interface; // 0x60(0x10)(ZeroConstructor, IsPlainOldData, NoDestructor)
...
public:
	...
	struct FFortTeamMemberInfo                   CallFunc_Array_Get_Item;                           // 0x230(0x190)(None)
