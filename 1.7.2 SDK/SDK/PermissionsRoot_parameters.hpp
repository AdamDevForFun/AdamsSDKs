...
public:
	...
	class FText                                  CallFunc_GetCurrentTheaterName_ReturnValue;        // 0x70(0x18)(None)
	...
	struct FFortTeamMemberInfo                   CallFunc_GetLocalPlayerTeamMemberInfo_LocalPlayerInfo; // 0x180(0x190)(None)
	...
	struct FFortTeamMemberInfo                   CallFunc_GetLocalPlayerTeamMemberInfo_LocalPlayerInfo2; // 0x378(0x190)(None)
	...
	class FText                                  CallFunc_Format_ReturnValue2;                      // 0x558(0x18)(None)
};
