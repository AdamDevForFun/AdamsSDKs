...
class UClass* UResults_BadgeLoot_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("Results_BadgeLoot_C");

	return Clss;
}


// Results_BadgeLoot_C Results_BadgeLoot.Default__Results_BadgeLoot_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UResults_BadgeLoot_C* UResults_BadgeLoot_C::GetDefaultObj()
{
	static class UResults_BadgeLoot_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UResults_BadgeLoot_C*>(UResults_BadgeLoot_C::StaticClass()->DefaultObject);
