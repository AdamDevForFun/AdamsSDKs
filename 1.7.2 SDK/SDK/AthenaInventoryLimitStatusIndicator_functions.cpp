...
class UClass* UAthenaInventoryLimitStatusIndicator_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("AthenaInventoryLimitStatusIndicator_C");

	return Clss;
}


// AthenaInventoryLimitStatusIndicator_C AthenaInventoryLimitStatusIndicator.Default__AthenaInventoryLimitStatusIndicator_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UAthenaInventoryLimitStatusIndicator_C* UAthenaInventoryLimitStatusIndicator_C::GetDefaultObj()
{
	static class UAthenaInventoryLimitStatusIndicator_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UAthenaInventoryLimitStatusIndicator_C*>(UAthenaInventoryLimitStatusIndicator_C::StaticClass()->DefaultObject);
