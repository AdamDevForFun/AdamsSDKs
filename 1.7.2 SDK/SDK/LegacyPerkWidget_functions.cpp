...
class UClass* ULegacyPerkWidget_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("LegacyPerkWidget_C");

	return Clss;
}


// LegacyPerkWidget_C LegacyPerkWidget.Default__LegacyPerkWidget_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class ULegacyPerkWidget_C* ULegacyPerkWidget_C::GetDefaultObj()
{
	static class ULegacyPerkWidget_C* Default = nullptr;

	if (!Default)
		Default = static_cast<ULegacyPerkWidget_C*>(ULegacyPerkWidget_C::StaticClass()->DefaultObject);
...
// struct FSlateBrush                 K2Node_Select2_Default                                           (None)
