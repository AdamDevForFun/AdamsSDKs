...
class UClass* UTeamScoreDetailsContent_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("TeamScoreDetailsContent_C");

	return Clss;
}


// TeamScoreDetailsContent_C TeamScoreDetailsContent.Default__TeamScoreDetailsContent_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UTeamScoreDetailsContent_C* UTeamScoreDetailsContent_C::GetDefaultObj()
{
	static class UTeamScoreDetailsContent_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UTeamScoreDetailsContent_C*>(UTeamScoreDetailsContent_C::StaticClass()->DefaultObject);
