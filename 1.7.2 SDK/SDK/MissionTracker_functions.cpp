...
class UClass* UMissionTracker_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("MissionTracker_C");

	return Clss;
}


// MissionTracker_C MissionTracker.Default__MissionTracker_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UMissionTracker_C* UMissionTracker_C::GetDefaultObj()
{
	static class UMissionTracker_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UMissionTracker_C*>(UMissionTracker_C::StaticClass()->DefaultObject);
