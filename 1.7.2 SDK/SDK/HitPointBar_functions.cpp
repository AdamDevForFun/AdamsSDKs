...
class UClass* UHitPointBar_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("HitPointBar_C");

	return Clss;
}


// HitPointBar_C HitPointBar.Default__HitPointBar_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UHitPointBar_C* UHitPointBar_C::GetDefaultObj()
{
	static class UHitPointBar_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UHitPointBar_C*>(UHitPointBar_C::StaticClass()->DefaultObject);
