...
class UClass* ULegacyButtonIconText_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("LegacyButtonIconText_C");

	return Clss;
}


// LegacyButtonIconText_C LegacyButtonIconText.Default__LegacyButtonIconText_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class ULegacyButtonIconText_C* ULegacyButtonIconText_C::GetDefaultObj()
{
	static class ULegacyButtonIconText_C* Default = nullptr;

	if (!Default)
		Default = static_cast<ULegacyButtonIconText_C*>(ULegacyButtonIconText_C::StaticClass()->DefaultObject);
