...
public:
	...
	struct FGameplayAbilityTargetDataHandle      Temp_struct_Variable2;                             // 0x90(0x20)(None)
	...
	struct FGameplayAbilityTargetDataHandle      Temp_struct_Variable3;                             // 0x110(0x20)(None)
	...
	struct FFortAbilityTargetSelection           CallFunc_Array_Get_Item;                           // 0x270(0x60)(None)
	...
	uint8                                        Pad_2E7D[0x6];                                     // Fixing Size After Last Property  [ Dumper-7 ]
