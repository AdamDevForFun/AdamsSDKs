...
// class FText                        CallFunc_GetCombinedTooltipDescription_ReturnValue               (None)
...
// class FText                        CallFunc_GetTooltipTitle_ReturnValue2                            (None)
...
void UPerkWidgetNew_C::InitializeText(const class FString& DescriptionText, class FText CallFunc_GetCombinedTooltipDescription_ReturnValue, TScriptInterface<class IFortClientAnnouncement_TutorialInterface> K2Node_DynamicCast_AsFort_Client_Announcement_Tutorial_Interface, bool K2Node_DynamicCast_bSuccess, class FText CallFunc_GetTooltipTitle_ReturnValue)
{
	static class UFunction* Func = nullptr;
...
// struct FSlateBrush                 CallFunc_ResizeBrush_NewParam                                    (None)
