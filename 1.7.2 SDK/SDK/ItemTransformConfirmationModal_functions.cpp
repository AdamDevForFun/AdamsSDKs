...
class UClass* UItemTransformConfirmationModal_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("ItemTransformConfirmationModal_C");

	return Clss;
}


// ItemTransformConfirmationModal_C ItemTransformConfirmationModal.Default__ItemTransformConfirmationModal_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UItemTransformConfirmationModal_C* UItemTransformConfirmationModal_C::GetDefaultObj()
{
	static class UItemTransformConfirmationModal_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UItemTransformConfirmationModal_C*>(UItemTransformConfirmationModal_C::StaticClass()->DefaultObject);
