...
class UClass* UMissionFocusWidget_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("MissionFocusWidget_C");

	return Clss;
}


// MissionFocusWidget_C MissionFocusWidget.Default__MissionFocusWidget_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UMissionFocusWidget_C* UMissionFocusWidget_C::GetDefaultObj()
{
	static class UMissionFocusWidget_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UMissionFocusWidget_C*>(UMissionFocusWidget_C::StaticClass()->DefaultObject);
...
// class FText                        CallFunc_GetCurrentFocusDisplayText_ReturnValue                  (None)
// UDelegateProperty_                 K2Node_CreateDelegate_OutputDelegate                             (ZeroConstructor, NoDestructor)
