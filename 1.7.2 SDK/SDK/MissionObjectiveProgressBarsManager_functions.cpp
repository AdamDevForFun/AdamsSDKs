...
class UClass* UMissionObjectiveProgressBarsManager_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("MissionObjectiveProgressBarsManager_C");

	return Clss;
}


// MissionObjectiveProgressBarsManager_C MissionObjectiveProgressBarsManager.Default__MissionObjectiveProgressBarsManager_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UMissionObjectiveProgressBarsManager_C* UMissionObjectiveProgressBarsManager_C::GetDefaultObj()
{
	static class UMissionObjectiveProgressBarsManager_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UMissionObjectiveProgressBarsManager_C*>(UMissionObjectiveProgressBarsManager_C::StaticClass()->DefaultObject);
