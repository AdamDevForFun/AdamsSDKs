...
class UClass* UAthenaTeamInfo_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("AthenaTeamInfo_C");

	return Clss;
}


// AthenaTeamInfo_C AthenaTeamInfo.Default__AthenaTeamInfo_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UAthenaTeamInfo_C* UAthenaTeamInfo_C::GetDefaultObj()
{
	static class UAthenaTeamInfo_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UAthenaTeamInfo_C*>(UAthenaTeamInfo_C::StaticClass()->DefaultObject);
