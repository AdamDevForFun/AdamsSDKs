...
public:
	...
	uint8                                        Pad_CF6[0x18];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_D01[0x2B];                                     // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_D10[0x8];                                      // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_D1A[0x488];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_D1B[0x8];                                      // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_D25[0xC];                                      // Fixing Size Of Struct [ Dumper-7 ]
