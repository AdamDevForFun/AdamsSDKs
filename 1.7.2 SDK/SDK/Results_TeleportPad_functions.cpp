...
class UClass* UResults_TeleportPad_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("Results_TeleportPad_C");

	return Clss;
}


// Results_TeleportPad_C Results_TeleportPad.Default__Results_TeleportPad_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UResults_TeleportPad_C* UResults_TeleportPad_C::GetDefaultObj()
{
	static class UResults_TeleportPad_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UResults_TeleportPad_C*>(UResults_TeleportPad_C::StaticClass()->DefaultObject);
