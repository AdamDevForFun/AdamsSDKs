...
public:
	...
	class FText                                  CallFunc_MakeLiteralText_ReturnValue3;             // 0x40(0x18)(None)
	class FText                                  CallFunc_MakeLiteralText_ReturnValue4;             // 0x58(0x18)(None)
	class FText                                  CallFunc_MakeLiteralText_ReturnValue5;             // 0x70(0x18)(None)
	class FText                                  K2Node_Select_Default;                             // 0x88(0x18)(None)
	class FText                                  CallFunc_MakeLiteralText_ReturnValue6;             // 0xA0(0x18)(None)
	class FText                                  CallFunc_MakeLiteralText_ReturnValue7;             // 0xB8(0x18)(None)
	class FText                                  CallFunc_MakeLiteralText_ReturnValue8;             // 0xD0(0x18)(None)
...
public:
	...
	uint8                                        Pad_2579[0x5];                                     // Fixing Size After Last Property  [ Dumper-7 ]
