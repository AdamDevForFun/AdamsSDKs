...
public:
	...
	class FText                                  Temp_text_Variable4;                               // 0xE0(0x18)(None)
...
public:
	...
	uint8                                        Pad_1CD0[0x6];                                     // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	...
	struct FHomebaseSquad                        CallFunc_TryGetHomebaseSquadData_OutHomebaseSquad; // 0xF0(0x88)(None)
	...
	struct FHomebaseSquadSlot                    CallFunc_Array_Get_Item;                           // 0x180(0x60)(None)
	...
	uint8                                        Pad_1CE4[0x5];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	class FText                                  CallFunc_ToText_ReturnValue;                       // 0x1E8(0x18)(None)
	...
	class FText                                  CallFunc_GetRestrictionReasonsAsText_Text;         // 0x238(0x18)(None)
	...
	uint8                                        Pad_1CE8[0x6];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	class FText                                  CallFunc_Format_ReturnValue2;                      // 0x300(0x18)(None)
