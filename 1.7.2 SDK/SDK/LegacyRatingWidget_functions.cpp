...
class UClass* ULegacyRatingWidget_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("LegacyRatingWidget_C");

	return Clss;
}


// LegacyRatingWidget_C LegacyRatingWidget.Default__LegacyRatingWidget_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class ULegacyRatingWidget_C* ULegacyRatingWidget_C::GetDefaultObj()
{
	static class ULegacyRatingWidget_C* Default = nullptr;

	if (!Default)
		Default = static_cast<ULegacyRatingWidget_C*>(ULegacyRatingWidget_C::StaticClass()->DefaultObject);
...
// struct FFortMultiSizeBrush         K2Node_Select_Default                                            (None)
// bool                               Temp_bool_Variable2                                              (ZeroConstructor, IsPlainOldData, NoDestructor)
// struct FFortMultiSizeBrush         K2Node_Select2_Default                                           (None)
