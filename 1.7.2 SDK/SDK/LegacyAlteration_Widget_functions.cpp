...
class UClass* ULegacyAlteration_Widget_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("LegacyAlteration_Widget_C");

	return Clss;
}


// LegacyAlteration_Widget_C LegacyAlteration_Widget.Default__LegacyAlteration_Widget_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class ULegacyAlteration_Widget_C* ULegacyAlteration_Widget_C::GetDefaultObj()
{
	static class ULegacyAlteration_Widget_C* Default = nullptr;

	if (!Default)
		Default = static_cast<ULegacyAlteration_Widget_C*>(ULegacyAlteration_Widget_C::StaticClass()->DefaultObject);
