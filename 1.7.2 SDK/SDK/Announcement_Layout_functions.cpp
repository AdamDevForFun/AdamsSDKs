...
class UClass* UAnnouncement_Layout_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("Announcement_Layout_C");

	return Clss;
}


// Announcement_Layout_C Announcement_Layout.Default__Announcement_Layout_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UAnnouncement_Layout_C* UAnnouncement_Layout_C::GetDefaultObj()
{
	static class UAnnouncement_Layout_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UAnnouncement_Layout_C*>(UAnnouncement_Layout_C::StaticClass()->DefaultObject);
