...
public:
	...
	class FText                                  Temp_text_Variable2;                               // 0x18(0x18)(None)
	class FText                                  Temp_text_Variable3;                               // 0x30(0x18)(None)
	class FText                                  Temp_text_Variable4;                               // 0x48(0x18)(None)
	class FText                                  Temp_text_Variable5;                               // 0x60(0x18)(None)
	class FText                                  Temp_text_Variable6;                               // 0x78(0x18)(None)
	class FText                                  Temp_text_Variable7;                               // 0x90(0x18)(None)
	class FText                                  Temp_text_Variable8;                               // 0xA8(0x18)(None)
	class FText                                  Temp_text_Variable9;                               // 0xC0(0x18)(None)
...
{
public:
	class FText                                  CallFunc_GetLocation_ReturnValue;                  // 0x0(0x18)(None)
