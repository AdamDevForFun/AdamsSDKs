...
public:
	...
	struct FFortItemTransformFilterTabLabelInfo  CallFunc_Array_Get_Item;                           // 0x20(0xC8)(None)
...
public:
	...
	struct FFortItemTransformFilterTabLabelInfo  CallFunc_Array_Get_Item;                           // 0x10(0xC8)(None)
...
public:
	...
	uint8                                        Pad_27C2[0x2];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	class FText                                  CallFunc_IsRecyclable_Reason;                      // 0x78(0x18)(None)
