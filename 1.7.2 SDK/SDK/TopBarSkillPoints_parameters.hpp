...
public:
	...
	class FText                                  CallFunc_Format_ReturnValue5;                      // 0x280(0x18)(None)
	...
	class FText                                  CallFunc_Format_ReturnValue6;                      // 0x328(0x18)(None)
	TArray<struct FFormatArgumentData>           K2Node_MakeArray_Array7;                           // 0x340(0x10)(ZeroConstructor, ReferenceParm)
	class FText                                  CallFunc_Format_ReturnValue7;                      // 0x350(0x18)(None)
...
public:
	...
	struct FFortTeamMemberInfo                   CallFunc_Array_Get_Item;                           // 0x58(0x190)(None)
