...
class UClass* UPotentialResourceWidget_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("PotentialResourceWidget_C");

	return Clss;
}


// PotentialResourceWidget_C PotentialResourceWidget.Default__PotentialResourceWidget_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UPotentialResourceWidget_C* UPotentialResourceWidget_C::GetDefaultObj()
{
	static class UPotentialResourceWidget_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UPotentialResourceWidget_C*>(UPotentialResourceWidget_C::StaticClass()->DefaultObject);
...
// (Public, HasDefaults, BlueprintCallable, BlueprintEvent)
// Parameters:
// class FText                        CallFunc_GetResourceCountAsText_Result                           (None)
