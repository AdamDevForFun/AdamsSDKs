...
class UClass* UItem_TierBadge_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("Item_TierBadge_C");

	return Clss;
}


// Item_TierBadge_C Item_TierBadge.Default__Item_TierBadge_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UItem_TierBadge_C* UItem_TierBadge_C::GetDefaultObj()
{
	static class UItem_TierBadge_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UItem_TierBadge_C*>(UItem_TierBadge_C::StaticClass()->DefaultObject);
