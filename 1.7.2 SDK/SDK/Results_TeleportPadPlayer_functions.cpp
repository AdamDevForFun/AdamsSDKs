...
class UClass* UResults_TeleportPadPlayer_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("Results_TeleportPadPlayer_C");

	return Clss;
}


// Results_TeleportPadPlayer_C Results_TeleportPadPlayer.Default__Results_TeleportPadPlayer_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UResults_TeleportPadPlayer_C* UResults_TeleportPadPlayer_C::GetDefaultObj()
{
	static class UResults_TeleportPadPlayer_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UResults_TeleportPadPlayer_C*>(UResults_TeleportPadPlayer_C::StaticClass()->DefaultObject);
