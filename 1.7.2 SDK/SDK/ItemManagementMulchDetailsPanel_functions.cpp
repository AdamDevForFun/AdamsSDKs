...
class UClass* UItemManagementMulchDetailsPanel_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("ItemManagementMulchDetailsPanel_C");

	return Clss;
}


// ItemManagementMulchDetailsPanel_C ItemManagementMulchDetailsPanel.Default__ItemManagementMulchDetailsPanel_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UItemManagementMulchDetailsPanel_C* UItemManagementMulchDetailsPanel_C::GetDefaultObj()
{
	static class UItemManagementMulchDetailsPanel_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UItemManagementMulchDetailsPanel_C*>(UItemManagementMulchDetailsPanel_C::StaticClass()->DefaultObject);
...
// class FText                        CallFunc_GetRecyclingWarningText_ReturnValue                     (None)
