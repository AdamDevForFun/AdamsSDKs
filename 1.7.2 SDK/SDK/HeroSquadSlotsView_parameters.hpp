...
public:
	...
	struct FSlateBrush                           K2Node_MakeStruct_SlateBrush2;                     // 0x110(0x90)(None)
	class FText                                  CallFunc_MakeLiteralText_ReturnValue;              // 0x1A0(0x18)(None)
	class FText                                  CallFunc_MakeLiteralText_ReturnValue2;             // 0x1B8(0x18)(None)
	class FText                                  CallFunc_MakeLiteralText_ReturnValue3;             // 0x1D0(0x18)(None)
	class FText                                  CallFunc_MakeLiteralText_ReturnValue4;             // 0x1E8(0x18)(None)
	class FText                                  Temp_text_Variable;                                // 0x200(0x18)(None)
	class FText                                  Temp_text_Variable2;                               // 0x218(0x18)(None)
	...
	class FText                                  Temp_text_Variable3;                               // 0x2D8(0x18)(None)
	class FText                                  Temp_text_Variable4;                               // 0x2F0(0x18)(None)
	...
	struct FSlateBrush                           K2Node_Select2_Default;                            // 0x330(0x90)(None)
	...
	class FText                                  K2Node_Select3_Default;                            // 0x3D0(0x18)(None)
	...
	class FText                                  CallFunc_Format_ReturnValue2;                      // 0x450(0x18)(None)
};
