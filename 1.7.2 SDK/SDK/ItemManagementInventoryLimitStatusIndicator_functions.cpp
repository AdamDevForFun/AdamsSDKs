...
class UClass* UItemManagementInventoryLimitStatusIndicator_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("ItemManagementInventoryLimitStatusIndicator_C");

	return Clss;
}


// ItemManagementInventoryLimitStatusIndicator_C ItemManagementInventoryLimitStatusIndicator.Default__ItemManagementInventoryLimitStatusIndicator_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UItemManagementInventoryLimitStatusIndicator_C* UItemManagementInventoryLimitStatusIndicator_C::GetDefaultObj()
{
	static class UItemManagementInventoryLimitStatusIndicator_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UItemManagementInventoryLimitStatusIndicator_C*>(UItemManagementInventoryLimitStatusIndicator_C::StaticClass()->DefaultObject);
