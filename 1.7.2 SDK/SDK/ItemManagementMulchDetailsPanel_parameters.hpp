...
public:
	...
	uint8                                        Pad_2CF9[0x5];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	class FText                                  CallFunc_GetWarningText_WarningText;               // 0xE8(0x18)(None)
	...
	class FText                                  Temp_text_Variable2;                               // 0x130(0x18)(None)
	...
	class FText                                  K2Node_Select2_Default;                            // 0x160(0x18)(None)
