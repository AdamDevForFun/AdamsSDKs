...
class UClass* UPlayerZoneTeamScoreContributionWidget_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("PlayerZoneTeamScoreContributionWidget_C");

	return Clss;
}


// PlayerZoneTeamScoreContributionWidget_C PlayerZoneTeamScoreContributionWidget.Default__PlayerZoneTeamScoreContributionWidget_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UPlayerZoneTeamScoreContributionWidget_C* UPlayerZoneTeamScoreContributionWidget_C::GetDefaultObj()
{
	static class UPlayerZoneTeamScoreContributionWidget_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UPlayerZoneTeamScoreContributionWidget_C*>(UPlayerZoneTeamScoreContributionWidget_C::StaticClass()->DefaultObject);
