...
public:
	...
	uint8                                        Pad_15A5[0x5];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	class FText                                  CallFunc_MakeLiteralText_ReturnValue2;             // 0x228(0x18)(None)
	...
	class FText                                  CallFunc_Format_ReturnValue3;                      // 0x318(0x18)(None)
};
...
public:
	...
	class FText                                  CallFunc_MakeLiteralText_ReturnValue2;             // 0xA0(0x18)(None)
