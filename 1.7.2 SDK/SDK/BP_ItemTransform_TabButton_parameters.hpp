...
public:
	...
	enum class ESlateVisibility                  Temp_byte_Variable2;                               // 0x1(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
	bool                                         CallFunc_Greater_IntInt_ReturnValue;               // 0x2(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                        Pad_22D0[0x1];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	float                                        CallFunc_Conv_IntToFloat_ReturnValue;              // 0x4(0x4)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                         Temp_bool_Variable;                                // 0x8(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
	enum class ESlateVisibility                  K2Node_Select_Default;                             // 0x9(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
	bool                                         CallFunc_EqualEqual_NameName_ReturnValue;          // 0xA(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
...
public:
	...
	enum class ESlateVisibility                  Temp_byte_Variable2;                               // 0x1(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
	bool                                         Temp_bool_Variable;                                // 0x2(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                        Pad_22D1[0x1];                                     // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	...
	struct FSlateColor                           K2Node_MakeStruct_SlateColor2;                     // 0x108(0x28)(None)
	struct FSlateColor                           K2Node_MakeStruct_SlateColor3;                     // 0x130(0x28)(None)
	struct FSlateColor                           K2Node_MakeStruct_SlateColor4;                     // 0x158(0x28)(None)
	struct FSlateColor                           K2Node_MakeStruct_SlateColor5;                     // 0x180(0x28)(None)
	struct FSlateColor                           K2Node_MakeStruct_SlateColor6;                     // 0x1A8(0x28)(None)
	struct FSlateColor                           K2Node_MakeStruct_SlateColor7;                     // 0x1D0(0x28)(None)
};
