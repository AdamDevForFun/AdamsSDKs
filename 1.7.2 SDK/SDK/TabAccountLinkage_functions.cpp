...
class UClass* UTabAccountLinkage_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("TabAccountLinkage_C");

	return Clss;
}


// TabAccountLinkage_C TabAccountLinkage.Default__TabAccountLinkage_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UTabAccountLinkage_C* UTabAccountLinkage_C::GetDefaultObj()
{
	static class UTabAccountLinkage_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UTabAccountLinkage_C*>(UTabAccountLinkage_C::StaticClass()->DefaultObject);
