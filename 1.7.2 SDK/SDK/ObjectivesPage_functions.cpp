...
class UClass* UObjectivesPage_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("ObjectivesPage_C");

	return Clss;
}


// ObjectivesPage_C ObjectivesPage.Default__ObjectivesPage_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UObjectivesPage_C* UObjectivesPage_C::GetDefaultObj()
{
	static class UObjectivesPage_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UObjectivesPage_C*>(UObjectivesPage_C::StaticClass()->DefaultObject);
