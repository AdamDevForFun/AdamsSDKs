...
public:
	...
	class FText                                  CallFunc_GetFriendCodeUrl_Result;                  // 0x8(0x18)(None)
	...
	class FText                                  CallFunc_GetFriendCodeUrl_Result2;                 // 0x40(0x18)(None)
	class FText                                  CallFunc_GetFriendCodeDescription_ReturnValue;     // 0x58(0x18)(None)
	struct FFormatArgumentData                   K2Node_MakeStruct_FormatArgumentData;              // 0x70(0x40)(HasGetValueTypeHash)
	class FText                                  CallFunc_GetFriendCodeDisplayName_ReturnValue;     // 0xB0(0x18)(None)
