...
class UClass* UEquippedItemWidget_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("EquippedItemWidget_C");

	return Clss;
}


// EquippedItemWidget_C EquippedItemWidget.Default__EquippedItemWidget_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UEquippedItemWidget_C* UEquippedItemWidget_C::GetDefaultObj()
{
	static class UEquippedItemWidget_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UEquippedItemWidget_C*>(UEquippedItemWidget_C::StaticClass()->DefaultObject);
...
// struct FSlateColor                 K2Node_Select3_Default                                           (None)
