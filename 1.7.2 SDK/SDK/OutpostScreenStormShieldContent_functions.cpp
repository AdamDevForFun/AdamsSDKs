...
class UClass* UOutpostScreenStormShieldContent_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("OutpostScreenStormShieldContent_C");

	return Clss;
}


// OutpostScreenStormShieldContent_C OutpostScreenStormShieldContent.Default__OutpostScreenStormShieldContent_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UOutpostScreenStormShieldContent_C* UOutpostScreenStormShieldContent_C::GetDefaultObj()
{
	static class UOutpostScreenStormShieldContent_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UOutpostScreenStormShieldContent_C*>(UOutpostScreenStormShieldContent_C::StaticClass()->DefaultObject);
