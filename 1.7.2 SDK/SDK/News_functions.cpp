...
class UClass* UNews_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("News_C");

	return Clss;
}


// News_C News.Default__News_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UNews_C* UNews_C::GetDefaultObj()
{
	static class UNews_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UNews_C*>(UNews_C::StaticClass()->DefaultObject);
