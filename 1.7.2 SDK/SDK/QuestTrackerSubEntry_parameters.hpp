...
public:
	...
	class FText                                  CallFunc_GetCombinedDescription_OutDescription;    // 0x40(0x18)(None)
	...
	class FText                                  CallFunc_GetEmptyText_ReturnValue;                 // 0x110(0x18)(None)
	...
	class FText                                  CallFunc_GetTooltipTextFromToken_OutText;          // 0x138(0x18)(None)
