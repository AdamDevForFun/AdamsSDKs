...
class UClass* UItemTransform_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("ItemTransform_C");

	return Clss;
}


// ItemTransform_C ItemTransform.Default__ItemTransform_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UItemTransform_C* UItemTransform_C::GetDefaultObj()
{
	static class UItemTransform_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UItemTransform_C*>(UItemTransform_C::StaticClass()->DefaultObject);
