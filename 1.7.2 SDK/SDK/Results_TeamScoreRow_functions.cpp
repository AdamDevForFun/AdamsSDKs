...
class UClass* UResults_TeamScoreRow_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("Results_TeamScoreRow_C");

	return Clss;
}


// Results_TeamScoreRow_C Results_TeamScoreRow.Default__Results_TeamScoreRow_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UResults_TeamScoreRow_C* UResults_TeamScoreRow_C::GetDefaultObj()
{
	static class UResults_TeamScoreRow_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UResults_TeamScoreRow_C*>(UResults_TeamScoreRow_C::StaticClass()->DefaultObject);
