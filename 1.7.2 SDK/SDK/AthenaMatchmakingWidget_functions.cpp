...
class UClass* UAthenaMatchmakingWidget_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("AthenaMatchmakingWidget_C");

	return Clss;
}


// AthenaMatchmakingWidget_C AthenaMatchmakingWidget.Default__AthenaMatchmakingWidget_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UAthenaMatchmakingWidget_C* UAthenaMatchmakingWidget_C::GetDefaultObj()
{
	static class UAthenaMatchmakingWidget_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UAthenaMatchmakingWidget_C*>(UAthenaMatchmakingWidget_C::StaticClass()->DefaultObject);
