...
public:
	...
	class UDailyRewardsEpic_C*                   CallFunc_Create_ReturnValue;                       // 0xC0(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class UHorizontalBoxSlot*                    CallFunc_AddChildToHorizontalBox_ReturnValue;      // 0xC8(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	class UDailyRewardsItem_C*                   CallFunc_Create_ReturnValue2;                      // 0xE0(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class UDailyRewardsItem_C*                   CallFunc_Create_ReturnValue3;                      // 0xE8(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class UHorizontalBoxSlot*                    CallFunc_AddChildToHorizontalBox_ReturnValue2;     // 0xF0(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	class UHorizontalBoxSlot*                    CallFunc_AddChildToHorizontalBox_ReturnValue3;     // 0x100(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	int32                                        CallFunc_Add_IntInt_ReturnValue;                   // 0x108(0x4)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FSlateChildSize                       K2Node_MakeStruct_SlateChildSize;                  // 0x10C(0x8)(NoDestructor)
	...
	struct FMargin                               K2Node_MakeStruct_Margin;                          // 0x11C(0x10)(NoDestructor)
	...
	bool                                         CallFunc_Less_IntInt_ReturnValue2;                 // 0x139(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                        Pad_3A93[0x6];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	struct FFortDailyRewardsItemData             CallFunc_Array_Get_Item;                           // 0x140(0x10)(NoDestructor)
	...
	struct FFortDailyRewardsItemData             CallFunc_Array_Get_Item2;                          // 0x158(0x10)(NoDestructor)
	...
	int32                                        CallFunc_Add_IntInt_ReturnValue3;                  // 0x16C(0x4)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	int32                                        CallFunc_Subtract_IntInt_ReturnValue2;             // 0x170(0x4)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                         CallFunc_LessEqual_IntInt_ReturnValue;             // 0x174(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
};
