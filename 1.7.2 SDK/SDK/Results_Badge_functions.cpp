...
class UClass* UResults_Badge_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("Results_Badge_C");

	return Clss;
}


// Results_Badge_C Results_Badge.Default__Results_Badge_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UResults_Badge_C* UResults_Badge_C::GetDefaultObj()
{
	static class UResults_Badge_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UResults_Badge_C*>(UResults_Badge_C::StaticClass()->DefaultObject);
