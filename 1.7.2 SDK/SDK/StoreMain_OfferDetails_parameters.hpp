...
public:
	...
	class FText                                  CallFunc_Conv_IntToText_ReturnValue2;              // 0x80(0x18)(None)
	...
	struct FFortMtxDetailsAttribute              CallFunc_Array_Get_Item;                           // 0xC8(0x30)(None)
	...
	class FText                                  CallFunc_GetNormalPrice_ReturnValue;               // 0x108(0x18)(None)
	class FText                                  CallFunc_GetSalePrice_SalePrice;                   // 0x120(0x18)(None)
	...
	class FText                                  CallFunc_GetName_ReturnValue;                      // 0x140(0x18)(None)
	...
	struct FSlateBrush                           CallFunc_GetDetailsImage_ReturnValue;              // 0x198(0x90)(None)
};
