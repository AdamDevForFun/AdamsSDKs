...
class UClass* UItemDurabilityMeter_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("ItemDurabilityMeter_C");

	return Clss;
}


// ItemDurabilityMeter_C ItemDurabilityMeter.Default__ItemDurabilityMeter_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UItemDurabilityMeter_C* UItemDurabilityMeter_C::GetDefaultObj()
{
	static class UItemDurabilityMeter_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UItemDurabilityMeter_C*>(UItemDurabilityMeter_C::StaticClass()->DefaultObject);
