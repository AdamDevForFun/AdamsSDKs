...
class UClass* UTooltipHeroBonuses_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("TooltipHeroBonuses_C");

	return Clss;
}


// TooltipHeroBonuses_C TooltipHeroBonuses.Default__TooltipHeroBonuses_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UTooltipHeroBonuses_C* UTooltipHeroBonuses_C::GetDefaultObj()
{
	static class UTooltipHeroBonuses_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UTooltipHeroBonuses_C*>(UTooltipHeroBonuses_C::StaticClass()->DefaultObject);
...
// struct FFortUIPerk                 CallFunc_Array_Get_Item                                          (None)
