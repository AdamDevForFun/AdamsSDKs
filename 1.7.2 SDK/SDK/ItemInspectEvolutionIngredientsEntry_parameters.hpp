...
public:
	...
	class FText                                  CallFunc_Conv_IntToText_ReturnValue2;              // 0x28(0x18)(None)
...
public:
	...
	struct FSlateBrush                           CallFunc_GetItemDefinitionSmallPreviewImageBrush_ReturnValue; // 0x98(0x90)(None)
};
...
public:
	...
	class FText                                  CallFunc_GetDisplayName_ReturnValue2;              // 0x50(0x18)(None)
};
