...
class UClass* UCollectionBar_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("CollectionBar_C");

	return Clss;
}


// CollectionBar_C CollectionBar.Default__CollectionBar_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UCollectionBar_C* UCollectionBar_C::GetDefaultObj()
{
	static class UCollectionBar_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UCollectionBar_C*>(UCollectionBar_C::StaticClass()->DefaultObject);
