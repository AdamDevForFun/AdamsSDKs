...
public:
	...
	struct FGameplayAbilityTargetDataHandle      Temp_struct_Variable2;                             // 0x48(0x20)(None)
	...
	struct FGameplayAbilityTargetDataHandle      Temp_struct_Variable4;                             // 0x128(0x20)(None)
	struct FFortGameplayEffectContainerSpec      CallFunc_MakeGameplayEffectContainerSpec_ReturnValue; // 0x148(0x80)(None)
	...
	struct FFortAbilityTargetSelection           CallFunc_Array_Get_Item;                           // 0x218(0x60)(None)
