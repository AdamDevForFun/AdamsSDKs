...
class UClass* UAmbientControllerComponent_Athena_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("AmbientControllerComponent_Athena_C");

	return Clss;
}


// AmbientControllerComponent_Athena_C AmbientControllerComponent_Athena.Default__AmbientControllerComponent_Athena_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UAmbientControllerComponent_Athena_C* UAmbientControllerComponent_Athena_C::GetDefaultObj()
{
	static class UAmbientControllerComponent_Athena_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UAmbientControllerComponent_Athena_C*>(UAmbientControllerComponent_Athena_C::StaticClass()->DefaultObject);
