...
public:
	...
	uint8                                        Pad_4AEC[0x18];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_4AED[0x28];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_4AEE[0x30];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
