...
struct ABP_CountdownMaster_C_UserConstructionScript_Params
{
public:
	...
	TArray<int32>                                K2Node_MakeArray_Array_1;                          // 0x18(0x10)(ZeroConstructor, ReferenceParm)
	TArray<int32>                                K2Node_MakeArray_Array_2;                          // 0x28(0x10)(ZeroConstructor, ReferenceParm)
	TArray<int32>                                K2Node_MakeArray_Array_3;                          // 0x38(0x10)(ZeroConstructor, ReferenceParm)
	...
	struct FHitResult                            CallFunc_K2_SetRelativeLocation_SweepHitResult_1;  // 0x144(0x8C)(IsPlainOldData, NoDestructor, ContainsInstancedReference)
};

// 0x4 (0x4 - 0x0)
// Function BP_CountdownMaster.BP_CountdownMaster_C.ExecuteUbergraph_BP_CountdownMaster
struct ABP_CountdownMaster_C_ExecuteUbergraph_BP_CountdownMaster_Params
{
public:
