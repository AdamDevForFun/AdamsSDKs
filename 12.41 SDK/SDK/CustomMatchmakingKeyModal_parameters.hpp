...
struct UCustomMatchmakingKeyModal_C_BndEvt__CloseButton_120_K2Node_ComponentBoundEvent_0_CommonButtonClicked__DelegateSignature_Params
{
public:
	class UCommonButton*                         Button;                                            // 0x0(0x8)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
...
public:
	...
	class FString                                CallFunc_GetCustomMatchmakingKey_ReturnValue;      // 0x30(0x10)(ZeroConstructor, HasGetValueTypeHash)
