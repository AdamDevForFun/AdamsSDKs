...
public:
	...
	uint8                                        Pad_110B[0x57];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_110C[0x15];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_110E[0x38];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_1110[0xF4];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_1116[0x40];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_111A[0x56];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_111B[0xC];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_111C[0x10];                                    // Fixing Size After Last Property  [ Dumper-7 ]
