...
{
public:
	uint8                                        Pad_2639[0x10];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_263B[0x36];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_263C[0x1];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_263D[0x298];                                   // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_263F[0x338];                                   // Fixing Size After Last Property  [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_2641[0x34];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_2642[0x28];                                    // Fixing Size Of Struct [ Dumper-7 ]
