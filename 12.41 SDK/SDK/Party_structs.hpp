...
{
public:
	uint8                                        Pad_31DC[0x18];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_31E2[0x37];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_31E3[0x10];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	TArray<class USocialChatChannel*>            ListenChannels;                                    // 0x18(0x10)(ZeroConstructor, NativeAccessSpecifierPublic)
	uint8                                        Pad_31E4[0x18];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_31E6[0x35];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_31E7[0x18];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
