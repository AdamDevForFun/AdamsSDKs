...
public:
	...
	uint8                                        Pad_F30[0x5];                                      // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_F38[0xA];                                      // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_F45[0x60];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_F46[0x50];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_F4A[0x9];                                      // Fixing Size Of Struct [ Dumper-7 ]
