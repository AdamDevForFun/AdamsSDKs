...
struct UDonut_fui_AcquisitionOffer_C_PreConstruct_Params
{
public:
...
struct UDonut_fui_AcquisitionOffer_C_ExecuteUbergraph_Donut_fui_AcquisitionOffer_Params
{
public:
	...
	struct FFortColorPalette                     CallFunc_BPGetRarityColorPalette_ReturnValue;      // 0x48(0x50)(NoDestructor)
	class UMaterialInstanceDynamic*              CallFunc_GetDynamicMaterial_ReturnValue_2;         // 0x98(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class UMaterialInstanceDynamic*              CallFunc_GetDynamicMaterial_ReturnValue_3;         // 0xA0(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
